...
const PAGE_DATA = {
  ...
  keyword: "Markup, HTML, frameset",
};

function FramesetDocumentPage() {
  usePageMeta({
    ...PAGE_DATA,
    layout: PAGE_LAYOUT,
  });
  ...
  <frameset cols="25%,75%">
    ...
    <frame src="content.html" name="rightFrame">
        ...
        <article className="mt_ml">
          ...
          <ol className="mt_m dot_lst info_lst gap-column-important-ms">
            <li className="weight-600-before t_black_before">
              ...
              <p>
                프레임은 서로 독립적인 문서로 구성되어 있기 때문에, 보조 기술이
                전체 페이지 구조를 인식하기 어렵습니다.
              </p>
            </li>
            <li className="weight-600-before t_black_before">
        ...
        <article className="mt_l">
          ...
          <ol className="mt_m dot_lst info_lst gap-column-important-ms">
            <li className="weight-600-before t_black_before">
              ...
              <p>
                수정 시 <b>여러 파일을 동시에 수정해야 하는 불편함</b>이
                있습니다.
              </p>
            </li>
            <li className="weight-600-before t_black_before">
              ...
              <p>
                <code>parent</code>, <code>top</code>, <code>frames[]</code>{" "}
                접근이 필요하여 <b>코드가 복잡하고 취약해집니다.</b>
              </p>
            </li>
            <li className="weight-600-before t_black_before">
        ...
        <article className="mt_l">
          ...
          <ol className="mt_m dot_lst info_lst gap-column-important-ms">
            <li className="weight-600-before t_black_before">
              ...
              <p>문서 내 특정 영역에 외부 콘텐츠 삽입.</p>
            </li>
            <li className="weight-600-before t_black_before">
              <strong>SPA (Single Page Application)</strong>
              <p>React/Vue/Angular 기반 동적 렌더링 구조.</p>
            </li>
            <li className="weight-600-before t_black_before">
              <strong>CSS Flexbox, Grid</strong>
              <p>프레임 분할 없이도 반응형 레이아웃 구현 가능.</p>
            </li>
          </ol>
        </article>
      </section>
      ...
      <figure className="img_figure mt_l">
        <img src={IMG.HTML + "/10_html_04.png"} alt="frameset 문서 구조" />
...
export default FramesetDocumentPage;
