...
const PAGE_DATA = {
  title: "키보드 사용 보장 | 웹 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '키보드 사용 보장'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 지체장애인, 파워 유저 및 개발자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 모든 기능은 키보드만으로도 사용할 수 있어야 한다.</b><br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#keyboard" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.1.1 키보드 (Keyboard) (Level A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#focus-visible" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.7 포커스 표시 (Focus Visible) (Level AA)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/keyboard.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Keyboard</a>
      			<a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/Guides/Keyboard-navigable_JavaScript_widgets" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - Keyboard accessibility</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				또한, 전통적인 키보드를 사용할 수 없는 지체장애인의 경우에는 음성 입력 장치 등 대체 입력 수단을 활용하더라도
      				웹 콘텐츠가 제공하는 모든 기능을 사용할 수 있어야 합니다.
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			마우스를 사용할 수 없는 사용자도 모든 기능을
      			<i className="key_tab">tab</i>, <i className="key_arrow">방향키</i>, <i className="key_enter">enter</i>,
      			<i className="key_space">space</i>, <i className="key_esc">esc</i> 등
      			키보드만으로 조작 가능하도록 구현되어야 합니다.
      			포커스 이동, 콘텐츠 탐색, 메뉴/탭 조작 등이 키보드 기반으로 가능해야 하며, <b>시각적 포커스 표시도 반드시 제공되어야 합니다.</b>
      		</p>
      		<ul className="mt_ms dot_lst gap-column-important-sm ">
      			...
      			<li>
      				포커스 이동만으로 웹 페이지의 전체 기능에 접근할 수 있어야 하며,
      				키보드 기반 보조기술과의 호환성도 확보되어야 합니다.
      			</li>
      		</ul>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더와 키보드 병행 사용</p>
      				</li>
      				<li>
      					<p className="cell value">지체장애인</p>
      					<p className="cell content">손떨림/장애로 마우스 조작 불가</p>
      				</li>
      				<li>
      					<p className="cell value">파워 유저 및 개발자</p>
      					<p className="cell content">키보드 단축키 활용</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				모든 인터랙션이
      				<i className="key_tab">tab</i>, <i className="key_enter">enter</i>, <i className="key_space">space</i>, <i className="key_esc">esc</i>, <i className="key_arrow">방향키</i>
      				등으로 작동 가능한가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 – 네비게이션 2Depth + 탭메뉴 구성</h3>

      			
      <CodeBlock title="html - 키보드 사용 보장" language="javascript" className="uk_gist_code_box">
      {`<nav>
      						<ul>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">Vue 예시 – 키보드 전용 탭 메뉴</h3>

      			
      <CodeBlock title="Vue - 키보드 사용 보장" language="html" className="uk_gist_code_box">
      {`<template>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">React 예시 – 키보드 내비게이션 포함</h3>

      			
      <CodeBlock title="React - 키보드 사용 보장" language="javascript" className="uk_gist_code_box">
      {`import { useState } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_red">미준수 사례 (키보드 사용 불가)</h3>

      			
      <CodeBlock title="키보드 사용 보장 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<div onclick="alert('제출되었습니다')">
      						제출하기
      					</div>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;div&gt;</code> 요소에 <code>onclick</code>만 적용되어 있어 마우스 사용자만 클릭 가능하며, 키보드로는 초점(포커스)도 이동되지 않고 작동하지 않습니다.
      				</dd>
      				<dd>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">준수 사례 (키보드 사용 가능)</h3>

      			
      <CodeBlock title="키보드 사용 보장 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<button type="button" onclick="alert('제출되었습니다')">
      						제출하기
      					</button>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;button&gt;</code> 요소는 기본적으로 키보드 접근(탭, 엔터/스페이스)과 스크린 리더 지원을 모두 제공합니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		<h2 className="ml_mn" data-conlist="false">검사항목 예외</h2>

      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>키보드 인터페이스와 기능</strong>
      				<p>
      					콘텐츠의 모든 기능은 키보드로 사용할 수 있어야 합니다.
      					이때 기능을 수행하기 위해 필요한 키보드 조작의 횟수는 고려 대상이 아닙니다.
      				</p>
      			</li>
      			<li>
      				<strong>예외 콘텐츠</strong>
      				<p>
      					커서의 움직임이 중요한 위치 지정 도구(예: 붓질 기능이 필요한 콘텐츠, 시뮬레이션, 지리정보 응용, 가상현실 등)나
      					움직임 측정 센서를 사용하는 콘텐츠는 예외로 간주됩니다.
      					하지만 이러한 콘텐츠도 위치 지정 도구나 센서를 이용한 기능을 제외한 나머지 인터페이스는 키보드만으로 사용할 수 있어야 합니다.
      				</p>
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/UI9dWJJnC5k?si=ZQF1tXC1feYlu0gR" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">키보드 사용 보장 | 웹 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
