...
const PAGE_LAYOUT = {
  mainClass: "web-application-accessibility",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "웹 애플리케이션 접근성 준수 | 웹 접근성 콘텐츠 제작 기법(\"견고성(Robust)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '웹 애플리케이션 접근성 준수'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 웹 애플리케이션, 보조기술 지원, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 지체 장애인, 시각장애인, 고령자, 인지 장애인",
}

function WebApplicationAccessibilityPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 콘텐츠에 포함된 웹 애플리케이션은 접근성이 있어야 한다.</b><br />
      			웹 애플리케이션이 포함된 콘텐츠는 모든 사용자가 기능을 동등하게 사용할 수 있도록 접근성이 보장되어야 하며,
      			이는 보조 기술 사용자에게도 동일한 기능을 제공할 수 있도록 구성해야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_ms dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				<strong>접근성 프로그래밍 인터페이스 대체수단 제공</strong>
      				<p>
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#keyboard" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.1.1 키보드 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#focus-order" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.4.3 포커스 순서 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#pointer-gestures" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.5.1 포인터 제스처 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#pointer-cancellation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.5.2 포인터 취소 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#label-in-name" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.5.3 레이블과 이름 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#motion-actuation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.5.4 동작 기반 작동 (레벨 A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#name-role-value" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 4.1.2 이름, 역할, 값 (레벨 A)</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/Accessibility" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN 웹 접근성 개요</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				웹 애플리케이션이 접근성을 제공할 경우, 보조 기술이 웹 애플리케이션과 상호작용할 수 있으므로,
      				보조 기술 사용자가 웹 애플리케이션을 활용할 수 있습니다.
      			</li>
      			<li>
      				웹 애플리케이션에 적용하려는 기능이 플랫폼 접근성 프로그래밍 인터페이스를 지원하지 못하더라도,
      				필수적인 접근성 정보를 플랫폼 접근성 프로그래밍 인터페이스를 통해 보조 기술로 제공할 수 있게 되므로,
      				새롭고 접근 가능한 기술 개발이 가능합니다.
      			</li>
      		</ul>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">보이지 않는 UI에 대한 명확한 안내 필요</p>
      				</li>
      				<li>
      					<p className="cell value">지체장애인</p>
      					<p className="cell content">키보드만으로 조작 가능한 환경 필요</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애인</p>
      					<p className="cell content">논리적 흐름, 오류 피드백 필요</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">명확하고 간단한 UI, 고대비 필요</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				동적 콘텐츠가 갱신될 때 <code>aria-live</code>로 알림을 제공하는가?
      			</li>
      			<li>
      				모든 컨트롤이 키보드로 조작 가능한가?
      			</li>
      			<li>
      				버튼, 입력 등의 인터랙션 요소에 <code>aria-label</code>이 적절히 부여되어 있는가?
      			</li>
      			<li>
      				<code>role</code>, <code>name</code>, <code>state</code>, <code>value</code>가 명확히 전달되는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				키보드만 사용해 기능을 조작해 보며
      				(<i className="key_tab">Tab</i>,
      				<i className="key_enter">Enter</i>,
      				<i className="key_space">Space</i>,
      				<i className="key_esc">Esc</i>,
      				<i className="key_arrow">Arrow</i> 등)
      				기능이 제대로 작동하는지 확인합니다.
      			</li>
      			<li>
      ...
      <CodeBlock title="html - 웹 애플리케이션 접근성 준수" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="Vue - 웹 애플리케이션 접근성 준수" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<button
      							@click="toggle"
      							aria-label="알림 열기"
      ...
      <CodeBlock title="React - 웹 애플리케이션 접근성 준수" language="javascript" className="uk_gist_code_box">
      {`function Notification() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				인터랙션 가능한 요소는 <code>role</code>, <code>name</code>, <code>state</code>, <code>value</code>가 적절히 제공되어야 합니다.
      			</li>
      		</ul>
      	</section>
      ...
      <CodeBlock title="웹 애플리케이션 접근성 준수 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<button onclick="submitForm()">Submit</button>`}
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>role</code> 속성이 누락되어 이 버튼이 실제로 어떤 역할을 하는지 명확하지 않습니다.
      				</dd>
      				<dd>
      					<code>aria-label</code>이 없어 버튼의 기능(예: &quot;제출하기&quot;)을 알 수 없습니다.
      				</dd>
      			</dl>
      		</article>
      ...
      <CodeBlock title="웹 애플리케이션 접근성 준수 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<button type="submit" aria-label="Submit form" role="button" aria-pressed="false">Submit</button>`}
      </CodeBlock>

      			<dl className="dl_dot_lst mt_ms">
      				<dt className="t_blue">설명 :</dt>
      				<dd>
      					<code>&quot;type=&quot;submit&quot;</code> 속성으로 버튼의 역할이 명확히 정의됩니다.
      				</dd>
      				<dd>
      					<code>aria-label=&quot;Submit form&quot;</code> 속성으로 버튼의 기능을 명확하게 전달합니다.
      				</dd>
      				<dd>
      					<code>role=&quot;button&quot;</code> 속성을 통해 이 요소가 버튼임을 명시합니다.
      				</dd>
      				<dd>
      					<code>aria-pressed=&quot;false&quot;</code> 속성으로 버튼이 눌려지지 않은 상태임을 나타내어 동적 상태를 표현합니다.
      				</dd>
      			</dl>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/bg1Uvnoi4-w?si=aTcktWtDPt7ZIRAy" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">웹 애플리케이션 접근성 준수 | 웹 접근성 콘텐츠 제작 기법(&quot;견고성(Robust)&quot;) 참조</strong>
...
export default WebApplicationAccessibilityPage
