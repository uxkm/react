...
const PAGE_DATA = {
  title: "반복 영역 건너뛰기 | 웹 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '반복 영역 건너뛰기'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 지체 장애 사용자, 비장애 사용자",
}

function BypassBlocksPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 콘텐츠의 반복되는 영역은 건너뛸 수 있어야 한다.</b><br />
      			웹사이트 상단의 메뉴, 검색창, 광고 영역 등
      			<b>
      				반복적으로 나타나는 콘텐츠 블록은 키보드 사용자와
      				스크린 리더 사용자들이 본문으로 빠르게 이동할 수 있도록 &quot;본문 바로가기(Skip to content)&quot; 링크를 제공
      			</b>해야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>반복 영역을 건너뛸 수 있는 수단 제공</strong>
      				<p>
      					웹 페이지가 제공하는 핵심 영역이 위치한 곳으로 직접 이동하는 건너뛰기 링크를 제공합니다.
      					건너뛰기 링크는 웹 페이지의 가장 앞에 제공합니다.
      				</p>
      			</li>
      			<li>
      			...
      			<li>
      				...
      				<p>
      					건너뛰기 링크는 시각장애인뿐만 아니라 지체장애인도 키보드 조작 횟수를 줄일 수 있게 하는 효과적인 수단이므로,
      					메뉴 건너뛰기 링크는 화면에 보이도록 구현해야 합니다.
      				</p>
      			</li>
      		</ul>
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#bypass-blocks" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.1 블록 건너뛰기 (Bypass Blocks) (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/bypass-blocks.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Bypass Blocks</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/HTML/Reference/Elements/a" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - HTML 링크 앵커</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				웹 페이지의 상단이나 좌측 프레임에 동일한 링크 목록이 반복되는 영역이 포함되어 있으면,
      				화면낭독프로그램은 이 링크 목록을 순서대로 읽어준 후에야 필요한 부분을 읽어주므로 매우 불편합니다.
      				마찬가지로, 키보드 사용자는 모든 링크 목록을 순차적으로 이동해야 핵심 영역으로 이동할 수 있어 매우 불편합니다.
      				그러나 웹 페이지의 첫 부분에 핵심 영역으로 이동할 수 있는 건너뛰기 링크를 제공하면,
      				키보드 사용자는 몇 번의 키보드 조작을 통해서 핵심 영역으로 빠르게 이동할 수 있습니다.
      			</li>
      			<li>
      				색인이 없는 긴 문장으로 구성된 콘텐츠의 경우, 콘텐츠의 특정 위치로 이동하는 것이 매우 불편합니다.
      				그러나 웹 페이지의 시작 부분에 색인을 제공하면, 필요한 부분으로 직접 이동할 수 있어 보다 쉽고 빠르게 내비게이션할 수 있습니다.
      				콘텐츠를 장, 절, 소절 등으로 구분하면, 웹브라우저 또는 보조기술이 제공하는 장, 절, 소절 간의 빠른 이동 수단을 이용할 수 있게 됩니다.
      			</li>
      			<li>
      				여러 페이지로 구성된 웹사이트에서 사이트 맵을 제공하면,
      				사용자는 이를 이용하여 필요한 정보가 위치한 페이지로 보다 쉽고 빠르게 이동할 수 있습니다.
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			키보드 사용자는 페이지가 로딩된 이후 모든 웹 페이지에 공통적으로 들어있는 메뉴 및 링크 목록 등을 탭 키를 이용하여
      			순차적으로 내비게이션한 후에 핵심 영역에 도달하게 됩니다.
      			화면낭독프로그램을 이용하는 사람은 메뉴 등을 페이지가 로딩되거나 갱신될 때마다
      			모든 웹 페이지에 공통적으로 들어있는 메뉴 등을 다시 듣게 됩니다.
      			키보드 사용자와 화면낭독프로그램 사용자가 겪게 되는 이러한 불편을 방지하기 위해,
      			사용자가 메뉴 등과 같은 반복 영역을 바로 건너뛰어 핵심 영역으로 직접 이동할 수 있는 수단을 제공해야 합니다.
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">반복된 탐색 없이 빠르게 본문으로 이동</p>
      				</li>
      				<li>
      					<p className="cell value">지체 장애 사용자</p>
      					<p className="cell content">키보드 조작 최소화 필요</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">효율적인 정보 접근</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				페이지 처음 로드 후 <i className="key_tab">Tab</i> 키로 “본문 바로가기” 링크를 확인합니다.
      			</li>
      			<li>
      ...
      <CodeBlock title="html - 반복 영역 건너뛰기" language="javascript" className="uk_gist_code_box">
      {`<!-- html 예시 -->
      ...
      <CodeBlock title="Vue - 반복 영역 건너뛰기" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 반복 영역 건너뛰기" language="javascript" className="uk_gist_code_box">
      {`function SkipLink() {
      						return (
      							<>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				Skip 링크가 시맨틱하게 <code>&lt;a&gt;</code> 태그로 구현되었는가?
      			</li>
      			<li>
      				포커스 시 사용자에게 인지 가능한가?
      			</li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				페이지 로딩 후, <i className="key_tab">Tab</i> 키를 눌러 첫 번째 포커스가 skip 링크로 이동하는지 확인합니다.
      			</li>
      			<li>
      				그 상태에서 클릭하거나 <i className="key_enter">Enter</i> 키를 누르면, 지정된 주요 영역으로 정상 이동되는지 확인합니다.
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		<h2 className="ml_mn">준수/미준수 사례<i> (반복 영역 건너뛰기 기능 없음)</i></h2>

      		<article className="mt_l indent">
      			<h3 className="ml_mn t_red">미준수 사례</h3>

      			
      <CodeBlock title="반복 영역 건너뛰기 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<header>
      						<nav>
      							<ul>
      								<li><a href="#">홈</a></li>
      ...
      <CodeBlock title="반복 영역 건너뛰기 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<a href="#main-content" class="skip-link">본문으로 건너뛰기</a>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					키보드 <i className="key_tab">Tab</i> 키로 초점 이동 시 해당 링크에 접근할 수 있습니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/O3z10F7Dnig?si=h8tuSN9T0xwamW5-" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">반복 영역 건너뛰기 | 웹 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default BypassBlocksPage
