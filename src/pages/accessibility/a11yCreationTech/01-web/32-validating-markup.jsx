...
const PAGE_DATA = {
  title: "마크업 오류 방지 | 웹 접근성 콘텐츠 제작 기법(\"견고성(Robust)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '마크업 오류 방지'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 문법 준수, 마크업, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각 장애인, 인지 장애인, 고령화, 키보드 사용자",
}

function ValidatingMarkupPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 마크업 언어의 요소는 열고 닫음, 중첩 관계 및 속성 선언에 오류가 없어야 한다.</b><br />
      			마크업 언어로 작성된 콘텐츠는 해당 마크업 언어의 문법을 최대한 준수하여 제공하는 것이 바람직합니다.<br />
      			특히 요소의 열고 닫음, 중첩 관계의 오류가 없도록 제공해야 합니다.
      			또한, 요소의 속성도 마크업 문법을 최대한 준수하여 제공하는 것이 바람직합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#parsing" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">4.1.1 구문 분석 (Parsing, Level A)</a>
      		</p>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더가 오류 없이 문서를 정확히 해석해야 함</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애인</p>
      					<p className="cell content">구조화된 콘텐츠로 정보 이해 향상</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">예측 가능한 레이아웃 제공</p>
      				</li>
      				<li>
      					<p className="cell value">키보드 사용자</p>
      					<p className="cell content">논리적인 포커스 순서 확보</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				태그는 열고 닫힘이 정확한가? (<code>&lt;div&gt;&lt;/div&gt;</code>)
      			</li>
      			<li>
      				중첩 순서가 올바른가? (<code>&lt;ul&gt;&lt;li&gt;항목&lt;/li&gt;&lt;/ul&gt;</code>)
      			</li>
      			<li>
      				중복된 <code>id</code>는 없는가?
      			</li>
      			<li>
      				<code>role</code>, <code>aria-*</code> 속성은 문법적으로 유효한가?
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<b>W3C Validator</b>를 통해 문법 유효성을 검사합니다.<br />

      				<a href="https://validator.w3.org/" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 mt_sm mb_s box_link external before_none">W3C Validator 바로가기</a>
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">HTML 예시 - 올바른 코드</h3>

      			
      <CodeBlock title="html - 마크업 오류 방지" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<meta charset="UTF-8" />
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">HTML 예시 - 잘못된 코드</h3>

      			
      <CodeBlock title="Vue - 마크업 오류 방지" language="html" className="uk_gist_code_box">
      {`<html>
      						<head>
      							<title>오류 예시</title>
      						</head>
      						<body><!-- body 닫힘 태그 누락 -->
      							<header><!-- header 닫힘 태그 누락 -->
      								<h1>제목
      							<main>
      								<section><!-- section 닫힘 태그 누락 -->
      									<p>닫힘 태그 누락
      							</main>
      					</html>`}
      </CodeBlock>
      ...
      <CodeBlock title="마크업 오류 방지 - 미준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html>
      						<head>
      							<title>마크업 오류 예시</title>
      						</head>
      						<body>
      							<h1>웹 접근성 테스트
      							<p>이 문서는 마크업 오류가 있습니다.
      							<ul>
      								<li>항목 1
      								<li>항목 2
      							</ul>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;h1&gt;</code>, <code>&lt;p&gt;</code>, <code>&lt;li&gt;</code> 태그가 닫히지 않았습니다.
      				</dd>
      				<dd>
      ...
      <CodeBlock title="마크업 오류 방지 - 준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<meta charset="UTF-8" />
      							<title>마크업 준수 예시</title>
      						</head>
      						<body>
      							<h1>웹 접근성 테스트</h1>
      							<p>이 문서는 올바른 마크업을 사용하고 있습니다.</p>
      							<ul>
      								<li>항목 1</li>
      								<li>항목 2</li>
      							</ul>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/Xz3qma1in28?si=6er5DLAhZYj-wP-c" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">마크업 오류 방지 | 웹 접근성 콘텐츠 제작 기법(&quot;견고성(Robust)&quot;) 참조</strong>
...
export default ValidatingMarkupPage
