...
const PAGE_DATA = {
  title: "반복 입력 정보 | 웹 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '반복 입력 정보'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 입력 도움, 반복 입력 정보, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 인지장애인, 고령자, 지체장애인, 저시력 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 반복되는 입력 정보는 자동 입력 또는 선택 입력할 수 있어야 한다.</b><br />
      			사용자가 동일한 정보를 반복해서 입력해야 하는 경우,
      			이전에 제공한 정보를 재입력할 필요 없이 자동 입력 또는 선택을 통해 사용할 수 있어야 하며,
      			이는 인지적 부담을 줄이고 접근성을 향상시키는 핵심 항목입니다.<br />
      			예를 들어, 온라인 구매에서 주문자와 수령자 주소가 동일한 경우,
      			이전 단계에서 입력한 주문자 주소를 수령자 주소에 재입력 없이 선택하여 자동으로 채울 수 있습니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#redundant-entry" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 3.3.8 반복 입력</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/HTML/Reference/Attributes/autocomplete" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - autocomplete 속성</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			기억 또는 인지 기능에 어려움을 겪는 사용자의 특정 정보에 대한 반복적인 입력으로 인한 스트레스와 실수 발생 가능성을 줄일 수 있습니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			...
      			음성 명령, 한 손 입력 등 다양한 대체 입력 방식을 사용하는 경우에도 반복 입력은 시간과 노력을 크게 늘립니다.<br />
      		...
      		<ul className="mt_m dot_lst gap-column-important-sm">
      			...
      			<li>
      				폼 자동완성 및 <b className="t_blue">이전 입력 활용<sup className="sup">1)</sup></b>은 사용성을 높이는 데 도움이 됩니다.
      			</li>
      		</ul>
      		<div className="mt_m t_blue">
      			<b>1) 이전 입력 활용</b>이란?<br />
      			<p className="indent_small">
      				사용자가 이전에 입력한 정보를 기억하고,
      				이를 바탕으로 새로운 입력을 더 빠르고 쉽게 할 수 있도록 도와주는 기능을 의미합니다.<br />
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">복잡한 입력 절차는 부담이 됨</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">기억 기반 입력 반복은 오류 유발 가능</p>
      				</li>
      				<li>
      					<p className="cell value">지체장애인</p>
      					<p className="cell content">반복된 타이핑은 신체적 피로를 유발</p>
      				</li>
      				<li>
      					<p className="cell value">저시력 사용자</p>
      					<p className="cell content">반복된 입력 시 포커스 이동이 어려울 수 있음</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_m">
      			...
      			따라서 웹사이트는 자체적으로 정보를 제공하고 중복 입력을 방지할 책임이 있습니다.<br />
      			단, <b>비밀번호 재입력</b>이나 <b>새로운 프로세스 시작으로 인해 이전 정보가 무효해지는 경우</b>는 예외로 인정됩니다.
      		</p>

      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 - 자동 완성 및 반복 입력 제어</h3>

      			
      <CodeBlock title="html - 반복 입력 정보" language="javascript" className="uk_gist_code_box">
      {`<form>
      						<label for="shipping_name">배송 받는 사람</label>
      						<input id="shipping_name" name="shipping_name" autocomplete="name" />

      						<label>
      							<input type="checkbox" id="sameAsShipping" onclick="copyInfo()"> 주문자 정보와 동일
      						</label>
      ...
      <CodeBlock title="Vue - 반복 입력 정보" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<form>
      							<label>배송 이름
      ...
      <CodeBlock title="React - 반복 입력 정보" language="javascript" className="uk_gist_code_box">
      {`import React, { useState } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			...
      			<div className="mt_ml indent">
      				...
      				<dl className="mt_ms dl_lst">
      					...
      					<dd>
      						<b>“주문자와 동일”</b> 체크 상자를 제공하여, 한 번 입력한 정보를 재사용할 수 있도록 합니다.
      					</dd>
      				</dl>
      			</div>
      		</article>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml indent">
      				<h4 className="ml_mn">이전에 입력한 정보를 자동으로 채우는 기능 제공</h4>
      				<p className="mt_s">
      					상품 주문 과정에서 주문자와 배송지가 동일한 경우,
      					<b>“주문자 정보와 동일”</b> 체크 상자를 제공하여 이름, 이메일, 휴대폰 번호 등
      					이미 입력한 정보를 자동으로 배송 정보에 반영할 수 있도록 합니다.
      				</p>
      				<figure className="img_figure mt_ms">
      					<img src={`${IMG.A11Y_TECH_W_U}/37/img-redundant-entry01.png`} alt="" />
      					<figcaption>
      						[출처 : 웹 접근성을 고려한 콘텐츠 제작기법 개정판]
      					</figcaption>
      				</figure>
      			...
      			<div className="mt_l indent">
      				<h4 className="ml_mn">이전에 입력한 선택 정보 유지</h4>
      				<p className="mt_s">
      					결제 단계에서 선택한 결제 방식(카드사, 할부 정보 등)이 외부 결제 페이지로 넘어가더라도 동일한 정보가 자동으로 반영되도록 합니다.
      				</p>
      				<figure className="img_figure mt_ms">
      					<img src={`${IMG.A11Y_TECH_W_U}/37/img-redundant-entry02.png`} alt="" />
      					<figcaption>
      						[출처 : 웹 접근성을 고려한 콘텐츠 제작기법 개정판]
      					</figcaption>
      				</figure>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/2IjGwbMutjA?si=L1QVx-9OxCJICbbO" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : 리베하얀
      		</p>
      ...
      <footer className="reference_box">
      	<strong className="tit">반복 입력 정보 | 웹 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
