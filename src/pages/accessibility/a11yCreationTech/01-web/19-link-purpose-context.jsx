...
const PAGE_LAYOUT = {
  mainClass: "link-purpose-context",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "적절한 링크 텍스트 | 웹 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '적절한 링크 텍스트'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 인지장애 사용자, 비장애 사용자",
}

function LinkPurposeContextPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 링크 텍스트는 용도나 목적을 이해할 수 있도록 제공해야 한다.</b><br />
      			링크는 주변 맥락을 통해 용도나 목적지를 명확하게 이해할 수 있는 링크 텍스트를 제공해야 합니다.<br />
      			즉, 링크 텍스트는 해당 링크가 어떤 페이지나 기능으로 연결되는지를 명확하게 알려야 하며, &quot;여기&quot;나 &quot;자세히 보기&quot;와 같은 모호한 표현은 피해야 합니다.
      			스크린 리더 사용자는 페이지 내 모든 링크 텍스트만 추출해 듣는 경우가 많으므로, <b>링크 자체만으로 그 목적을 이해할 수 있어야 합니다.</b>
      		</p>
      	</blockquote>
      		...
      		<ol className="mt_l ol_lst info_lst gap-column-important-m">
      			<li className="weight-600-before t_black_before">
      				...
      				<ul className="dot_lst mt_sm">
      					<li>
      						<b>문장의 일부분에 링크를 연결하는 경우</b> : URL(Uniform Resource Locator) 목적지, 용도 등을 표현한 텍스트에 링크를 연결해야 합니다.
      					</li>
      					<li>
      						<b>'바로가기', 'GO' 등의 링크 텍스트를 제공하는 경우</b> : URL에 관한 정보를 제공하는 텍스트에 이어서 링크 텍스트를 삽입해야 합니다.
      					</li>
      					<li>
      						<b>이미지 링크를 제공하는 경우</b> : URL에 관한 정보를 제공하는 텍스트와 URL로 이동하는 이미지 링크는
      						하나의 링크로 구성하는 것이 바람직합니다. 이 경우, 이미지 링크의 대체 텍스트는 공백 문자로 제공해야 합니다.
      					</li>
      					<li>
      						동일한 제품을 서로 다른 관점에서 각각 설명한 페이지로 이동하는 링크들은 각 링크 텍스트를 서로 다르게 구성하는 것이 바람직합니다.
      					</li>
      					<li>
      						탭(tab) 컨트롤을 이용하여 공지사항 목록을 나열하고, 주변에 '더보기' 링크를 제공하는 콘텐츠에서
      						'더보기' 링크는 그 맥락으로부터 '공지사항 더보기'임을 알 수 있어야 합니다.
      					</li>
      				</ul>
      			</li>
      			<li className="weight-600-before t_black_before">
      				...
      				<p>
      					아이콘(icon)을 사용하여 링크 텍스트를 대체한
      					경우(예: 홈 페이지로 이동하는 링크를 집 모양의 아이콘으로 대체하고 해당 아이콘에 링크를 걸어놓은 경우),
      					아이콘 자체만으로도 링크의 용도, 목적지, 내용 등을 직관적이고 명확하게 이해할 수 있도록 제공해야 합니다.
      					아이콘에 대한 대체 텍스트 제공 방법은 검사항목 5.1.1의 '적절한 대체 텍스트 제공'을 참고해야 합니다.
      				</p>
      			</li>
      		</ol>
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#link-purpose-in-context" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.4 링크 목적(문맥 내) (Level A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#link-purpose-link-only" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.9 링크 목적(링크만) (Level AAA)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#link-purpose-link-only" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 2.4.9 Link Purpose (Link Only)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-in-context.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Link Purpose</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			텍스트에 링크를 연결할 때, ‘<b>여기를 클릭하세요.</b>’와 같이 애매모호한 표현을 사용하는 것은 시각장애인,
      			지적장애인뿐만 아니라 비장애인에게도 클릭 후 어떤 일이 발생할지 불명확하게 만듭니다.<br />
      			그러나 링크 텍스트를 직관적으로 구성하면, 장애인을 포함한 모든 사용자가 링크를 클릭했을 때 어떤 내용이 제시될지 명확히 알 수 있습니다.
      			이렇게 하면, 시각장애인이나 지적장애인도 불필요한 콘텐츠 간 이동을 피하고 맥락을 보다 쉽게 이해할 수 있습니다.
      		</p>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">링크 텍스트만으로도 페이지 용도 파악 필요</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">반복적인 비유적 표현은 혼동을 유발함</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">링크 목적 명확성은 사용성과 직접 연결됨</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 – 명확한 링크 텍스트</h3>

      			
      <CodeBlock title="html - 적절한 링크 텍스트" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="Vue - 적절한 링크 텍스트" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 적절한 링크 텍스트" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="적절한 링크 텍스트 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<a href="https://www.example.com">클릭하세요</a>
        				<a href="https://www.example.com">여기</a>`}
      </CodeBlock>
      ...
      <CodeBlock title="적절한 링크 텍스트 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<a href="https://www.example.com" title="Example 웹사이트로 이동">Example 웹사이트로 이동</a>
      					<a href="https://www.example.com/contact" title="문의 페이지로 이동">문의 페이지로 이동</a>`}
      </CodeBlock>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/C4AvmYc7E8E?si=u3bKTkaGA56KYd1X" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">적절한 링크 텍스트 | 웹 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default LinkPurposeContextPage
