...
const PAGE_LAYOUT = {
  mainClass: "three-flashes-or-below-threshold",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "깜빡임과 번쩍임 사용 제한 | 웹 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '깜빡임과 번쩍임 사용 제한'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 광과민성 간질 사용자, 인지장애 사용자, 비장애 사용자",
}

function ThreeFlashesOrBelowThresholdPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 초당 3~50회 주기로 깜빡이거나 번쩍이는 콘텐츠를 제공하지 않아야 한다.</b><br />
      			깜빡이거나(blinking) 번쩍이는(flashing) 콘텐츠로 인해 발작을 일으키지 않도록 초당 3∼50회 주기로 깜빡이거나 번쩍이는 콘텐츠를 제공하지 않아야 합니다.
      			10인치 이상의 스크린을 채용하고 있는 정보통신기기(태블릿 기기, PC 모니터, 무인 안내기 등)에서는 콘텐츠에 의한 광과민성 발작 가능성을 특히 주의해야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>번쩍이는 콘텐츠 사용 금지</strong>
      				<p>
      					번쩍임이 초당 3~50회이며, 10인치 이상의 화면에 표시된 번쩍이는 콘텐츠가 차지하는 면적의 합이
      					화면 전체 면적의 10%를 넘지 않아야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>깜빡이는 콘텐츠 사용 금지</strong>
      				<p>
      					초당 3~50회의 속도로 깜빡거리게 만든 콘텐츠는 그 깜빡임을 정지시킬 수 있어야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>번쩍이는 시간 제한</strong>
      				<p>
      					웹 페이지에 포함되는 콘텐츠의 번쩍이는 시간을 3초 미만으로 제한하면,
      					지속적인 번쩍임으로 인한 사용자(예: 광과민성 증후 환자, 학습장애인,
      					저시력장애인 등)의 발작을 예방하면서도 콘텐츠의 중요성을 알릴 수 있습니다.
      				</p>
      			</li>
      		</ul>
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#three-flashes-or-below-threshold" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.3.1 삼광 플래시 임계값을 넘지 않음 (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/three-flashes-or-below-threshold.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Three Flashes</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/CSS/animation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - CSS animation 속성</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			광과민성 증후군이 있는 사용자는 번쩍이는 빛에 민감하게 반응해 발작을 일으킬 수 있으므로,
      			본 검사항목을 준수한 콘텐츠는 해당 사용자도 <b>안전하게 접근</b>할 수 있습니다.<br />
      			또한 <b>주의 집중이 어려운 사용자</b>에게도
      			지속적인 번쩍거림 없이 설계된 콘텐츠는 <b>집중을 방해하지 않으며, 접근성을 높이는 데 도움이 됩니다.</b>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			깜빡이거나 번쩍이는 콘텐츠는 <b>광과민성 발작</b>(Photosensitive Epilepsy) 을 유발할 수 있으므로,
      			콘텐츠는 초당 3~50회 사이의 깜빡임을 포함하지 않아야 하며,
      			<b>애니메이션 또는 영상 효과 사용 시 반드시 주기와 속도를 제어</b>해야 합니다.
      		</p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					<p className="cell value">광과민성 간질 사용자</p>
      					<p className="cell content">특정 주기의 깜빡임에 민감하게 반응</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">강한 시각 자극으로 혼란 유발</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">과도한 번쩍임으로 인한 시각 피로</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      ...
      <CodeBlock title="html - 깜빡임과 번쩍임 사용 제한" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="Vue - 깜빡임과 번쩍임 사용 제한" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 깜빡임과 번쩍임 사용 제한" language="html" className="uk_gist_code_box">
      {`function SafeBlink() {
      						return (
      							<div style={{
      								animation: 'fade 2s ease-in-out infinite',
      ...
      <CodeBlock title="깜빡임과 번쩍임 사용 제한 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<div class="flashing-element"></div>
      ...
      <CodeBlock title="깜빡임과 번쩍임 사용 제한 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<div class="flashing-element"></div>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/q0GeFyxNnJE?si=sM8X3SP-sOG8tLza" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">깜빡임과 번쩍임 사용 제한 | 웹 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default ThreeFlashesOrBelowThresholdPage
