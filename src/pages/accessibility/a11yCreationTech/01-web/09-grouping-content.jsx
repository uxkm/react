...
const PAGE_DATA = {
  title: "콘텐츠 간의 구분 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '콘텐츠 간의 구분'에 대해 소개합니다.",
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 이웃한 콘텐츠는 구별될 수 있어야 한다.</b><br />
      			웹 페이지를 구성하는 이웃한 콘텐츠는 시각적으로 구분되도록 제공해야 하며,
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_ml success_criteria">
      			...
      			<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/section" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - HTML Sectioning Elements</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			이웃한 콘텐츠를 명확하게 구분할 수 있어 정보의 이해와 탐색이 용이해집니다.
      			시각적 요소나 화면 낭독 프로그램을 사용하는 사용자 모두 콘텐츠의 구분을 쉽게 인식할 수 있으며,
      			웹사이트의 내비게이션을 효율적으로 돕고, 사용자 경험을 향상시킵니다.<br />
      			또한, 명확한 구분을 통해 혼동을 줄여 더 빠르고 정확한 정보 접근을 가능하게 하여,
      			특히 장애가 있는 사용자들에게 웹을 더욱 친숙하고 접근 가능하게 만듭니다.
      		</p>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">콘텐츠 그룹 간 구조적 구분 필요</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">명확한 시각적 구분이 정보 이해에 도움</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">레이아웃 정돈을 통한 정보 흐름 이해 용이</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				구조적 마크업(<code>&lt;section&gt;</code>, <code>&lt;article&gt;</code>, <code>&lt;nav&gt;</code>, <code>&lt;aside&gt;</code> 등)을 활용했는가?
      			</li>
      			<li>
      ...
      <CodeBlock title="html - 콘텐츠 간의 구분" language="javascript" className="uk_gist_code_box">
      {`<section>
      						<h2>공지사항</h2>
      						<!-- ...content... -->
      					</section>
      ...
      <CodeBlock title="Vue - 콘텐츠 간의 구분" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 콘텐츠 간의 구분" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="콘텐츠 간의 구분 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<div>
      						<p>오늘의 날씨는 맑고 기온은 25도입니다.</p>
      						<p>우리는 새로운 서비스 출시를 준비 중입니다.</p>
      					</div>`}
      </CodeBlock>
      ...
      <CodeBlock title="콘텐츠 간의 구분 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<div>
      						<h2>오늘의 날씨</h2>
      						<p>오늘의 날씨는 맑고 기온은 25도입니다.</p>
      					</div>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/Zk0HSiIWSEU?si=v7lMoj3BvVZc4NMv" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">콘텐츠 간의 구분 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default GroupingContentPage
