...
const PAGE_DATA = {
  title: "텍스트 콘텐츠의 명도 대비 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '텍스트 콘텐츠의 명도 대비'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 명도 대비, 저시력 사용자, 색상 대비, 사용자 인터페이스, 텍스트 가독성, 고령자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 텍스트 콘텐츠와 배경 간의 명도 대비는 4.5 대 1 이상이어야 한다.</b><br />
      			웹 페이지에서 보이는 텍스트 콘텐츠(텍스트 및 텍스트 이미지)와 배경 간의 충분한 대비를 제공하여,
      			저시력장애인, 색각장애인, 고령자 등도 콘텐츠를 인식할 수 있도록 제공해야 합니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#contrast-minimum" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">1.4.3 명도 대비(최소) (Level AA)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#contrast-enhanced" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">1.4.6 명도 대비(향상된) (Level AAA)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Contrast (Minimum)</a>
      			<a href="https://webaim.org/resources/contrastchecker/" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WebAIM Contrast Checker</a>
      			<a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/Guides/Colors_and_Luminance" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - Color and accessibility</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>저시력 사용자도 정보 인식 가능</strong>
      				<p>
      			...
      			<li>
      				<strong>모든 사용자에게 가독성 향상</strong>
      				<p>
      					색맹, 피로 누적 사용자, 다양한 디스플레이 환경에서 명도 대비는 전반적인 <b>가독성을 높여</b> 사용자 만족도를 향상시킵니다.
      				</p>
      			</li>
      			<li>
      				<strong>사용자 오류 감소</strong>
      				<p>
      					텍스트 인식 오류로 인한 <b>입력 실수, 정보 오독</b>을 줄일 수 있어 웹 사용의 정확도와 효율성이 높아집니다.
      				</p>
      			</li>
      			<li>
      				<strong>접근성 법규 및 지침 준수</strong>
      				<p>
      					WCAG 2.2, KWCAG 2.2 등 국내외 접근성 기준을 만족시켜 <b>인증 및 법적 요구사항</b>을 충족할 수 있습니다.
      				</p>
      			</li>
      			<li>
      				<strong>디지털 콘텐츠의 신뢰도 향상</strong>
      				<p>
      					명확하게 읽을 수 있는 디자인은 사용자의 <b>브랜드 신뢰도 향상에도 기여</b>합니다.
      				</p>
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			텍스트와 배경 간의 충분한 명도 대비를 확보해야 <b>시력이 낮거나 저시력 사용자가 텍스트를 명확하게 인식할 수 있습니다.</b>
      			특히 기본 텍스트는 <b>4.5:1</b> 이상, 큰 텍스트(<code>18pt</code> 이상 또는 굵은 <code>14pt</code> 이상)는 <b>3:1</b> 이상의 대비를 확보해야 합니다.
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">대비가 낮은 텍스트 인식이 어려움</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">시력 감퇴로 인해 대비 부족 시 정보 인지 불가</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">밝은 화면에서 가독성 확보에 유리</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				텍스트와 배경 간의 명도 대비 비율이 <b>4.5:1</b> 이상인가?
      			</li>
      			<li>
      				큰 텍스트의 경우 <b>3:1</b> 이상인가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				WebAIM Contrast Checker, Axe DevTools 같은 <b>명도 대비 측정 도구를 사용하는 것이 좋습니다.</b>
      			</li>
      			<li>
      				Chrome 개발자 도구의 <b>접근성 탭을 이용해서 테스트 수 있습니다.</b>
      			</li>
      			<li>
      				<b>저시력 사용자를 대상으로 테스트하는 방법도 유용합니다.</b>
      			</li>
      		</ul>
      	</section>
      ...
      <CodeBlock title="html - 텍스트 콘텐츠의 명도 대비" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="Vue - 텍스트 콘텐츠의 명도 대비" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 텍스트 콘텐츠의 명도 대비" language="html" className="uk_gist_code_box">
      {`function ContrastText() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				WCAG 2.2 기준 대비율(<b>4.5:1</b> 또는 <b>3:1</b>)을 충족하는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				...
      				<p>
      					텍스트와 배경 색상 코드를 입력하여 명도 대비 비율을 확인할 수 있습니다.
      					WCAG 기준에 따라 일반 텍스트는 <b>4.5:1</b> 이상, 큰 텍스트는 <b>3:1</b> 이상이어야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>Chrome 개발자 도구 - 접근성 탭</strong>
      				<p>
      					요소를 선택한 후 <code>Accessibility</code> 탭에서 <b>Contrast</b> 항목을 통해 명도 대비를 확인할 수 있습니다.
      					기준 미달일 경우 &quot;Fail&quot;로 표시됩니다.
      				</p>
      			</li>
      			<li>
      				<strong>CSS에서 색상 확인</strong>
      				<p>
      					<code>color</code>와 <code>background-color</code> 속성 값을 확인하여,
      					대비 측정 도구에 입력해 적절한 명도 대비를 갖추었는지 확인할 수 있습니다.
      				</p>
      			</li>
      		</ul>
      	</section>
      ...
      <UkEditorTarget target="a11yCreationTech/web/08-contrast-minimum_1.html" className="uk_editor min_height_300 mb_result_height_200" mode="htmlmixed" theme="ayu-mirage" browser="default" result minHeight="300px" mbResultHeight="200px" />
      </Suspense>
      </div>
      			<dl className="dl_dot_lst mt_ms">
      				<dt className="t_red">문제점 :</dt>
      				<dd>
      					텍스트 색상 <code>#B0B0B0</code>(회색)과 배경 색상 <code>#FFFFFF</code>(흰색)의 <b>명도 대비 비율이 낮아</b>,
      					시각 장애가 있는 사용자, 특히 <b>저시력 사용자에게 텍스트를 읽기 어려운 환경을 만듭니다.</b>
      				</dd>
      				<dd>
      					<b>WCAG 2.1</b>에서는 텍스트와 배경 색상 간의 대비 비율이 <b>최소 4.5:1</b>이어야 한다고 권장합니다.
      				</dd>
      			</dl>
      		</article>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="view_editor edit_code mt_m">
      <Suspense fallback={<EditorFallback />}>
      <UkEditorTarget target="a11yCreationTech/web/08-contrast-minimum_2.html" className="uk_editor min_height_300 mb_result_height_200" mode="htmlmixed" theme="ayu-mirage" browser="default" result minHeight="300px" mbResultHeight="200px" />
      </Suspense>
      </div>
      			<dl className="dl_dot_lst mt_ms">
      				<dt className="t_blue">설명 :</dt>
      				<dd>
      					텍스트 색상 <code>#333333</code>(어두운 회색)과 배경 색상 <code>#FFFFFF</code>(흰색)의 <b>명도 대비 비율이 충분히 높아</b>
      					모든 사용자가 텍스트를 쉽게 읽을 수 있습니다.
      				</dd>
      				<dd>
      					<b>명도 대비 비율</b>이 <b>4.5:1</b> 이상으로, <b>WCAG 2.1</b> 기준을 준수합니다.
      				</dd>
      				<dd>
      					시각적으로 제한된 사용자들에게도 <b>더 나은 읽기 경험을 제공</b>합니다.
      				</dd>
      			</dl>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/yW52iPpb-JA?si=UFfksQq0ZdfO-r2H" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">텍스트 콘텐츠의 명도 대비 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
