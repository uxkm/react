...
const PAGE_DATA = {
  title: "표의 구성 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '표의 구성'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 인지장애 사용자, 모든 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 표는 이해하기 쉽게 구성해야 한다.</b><br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#info-and-relationships" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">1.3.1 정보 및 관계 (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/info-and-relationships.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Info and Relationships</a>
      			<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/table" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - table</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<b>제목 셀과 데이터 셀이 명확히 구분된 데이터 테이블</b>은,
      				시각장애인 사용자에게 각 <b>데이터 셀이 어떤 제목 셀과 연결되는지 또는 어떤 관계가 있는지</b>를 전달할 수 있습니다.
      			</li>
      			<li>
      				이를 통해 <b>데이터의 의미를 보다 쉽게 파악할 수 있게 되며</b>,
      				스크린 리더 사용 시 정보 전달의 정확성과 이해도가 향상됩니다.
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			표는 데이터를 구조적으로 제공하는 도구로, <b>적절한 헤더</b>(<code>&lt;th&gt;</code>), <b>범위 지정</b>(<code>scope</code>),
      			<b>캡션</b>(<code>caption</code>) 등을 통해
      			스크린 리더 사용자와 모든 사용자에게 정보를 명확히 전달해야 합니다.
      			특히 복잡한 표일수록 시각뿐 아니라 논리적으로 구조화되어 있어야 합니다.
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더가 헤더-셀 관계를 정확히 안내해야 이해 가능</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">데이터가 잘 정리되어야 의미를 파악하기 쉬움</p>
      				</li>
      				<li>
      					<p className="cell value">모든 사용자</p>
      					<p className="cell content">구조적 정보는 사용성과 가독성을 높임</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;caption&gt;</code> 요소로 표 제목이 명확히 설명되었는가?
      			</li>
      			<li>
      				<code>&lt;th&gt;</code>를 사용해 머리글 셀이 정의되어 있는가?
      			</li>
      			<li>
      				<code>scope=&quot;col&quot;</code> 또는 <code>scope=&quot;row&quot;</code>를 통해 헤더의 범위가 명시되었는가?
      			</li>
      			<li>
      				복잡한 표의 경우 <code>headers</code>, <code>id</code> 속성을 활용하여 관계를 정의했는가?
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				<code>&lt;caption&gt;</code>, <code>&lt;th&gt;</code>, <code>scope</code> 사용 여부를 확인합니다.
      			</li>
      			<li>
      				복잡한 경우 <code>headers</code>, <code>id</code> 속성의 관계 매핑을 확인합니다.
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				헤더 정의 비율 (표 내 <code>&lt;th&gt;</code> 포함률)
      			</li>
      			<li>
      				범위 지정 비율 (<code>scope</code> 속성 사용률)
      			</li>
      			<li>
      ...
      <CodeBlock title="html - 표의 구성" language="javascript" className="uk_gist_code_box">
      {`<table>
      ...
      <CodeBlock title="Vue - 표의 구성" language="html" className="uk_gist_code_box">
      {`<template>
      						<table>
      ...
      <CodeBlock title="React - 표의 구성" language="javascript" className="uk_gist_code_box">
      {`function UserTable({ users }) {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				모든 표에 <code>&lt;th&gt;</code> 및 <code>scope</code> 속성이 포함되어 있는가?
      			</li>
      			<li>
      				표 제목이 <code>&lt;caption&gt;</code> 또는 시각적으로 설명되어 있는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				코드 내 <code>&lt;table&gt;</code> 구성 요소를 확인합니다.
      			</li>
      			<li>
      				스크린 리더로 표를 읽을 때 헤더-셀 연결을 확인합니다.
      			</li>
      			<li>
      				시멘틱 마크업 존재 여부 및 <code>scope</code> 속성을 확인합니다.
      			</li>
      		</ul>
      	</section>
      ...
      <CodeBlock title="표의 구성 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<table>
      						<tr>
      							<td></td>
      							<td colspan="2">1분기</td>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;th&gt;</code> 없이 모든 셀을 <code>&lt;td&gt;</code>로 처리하는 경우, 스크린 리더는 구조를 인식하지 못합니다.
      				</dd>
      				<dd>
      					<code>scope</code>, <code>id</code>, <code>headers</code>가 없는 경우, 데이터와 헤더를 연결할 수 없습니다.
      				</dd>
      				<dd>
      					<code>&lt;caption&gt;</code>이 없는 경우, 표의 주제를 파악하기 어렵습니다.
      				</dd>
      			</dl>
      		</article>
      ...
      <CodeBlock title="표의 구성 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<table>
      						<caption>2025년 전국 지역별 분기별 매출 현황</caption>
      						<thead>
      							<tr>
      								<th id="region" rowspan="2" scope="col">지역</th>
      								<th id="q1" colspan="2" scope="colgroup">1분기</th>
      								<th id="q2" colspan="2" scope="colgroup">2분기</th>
      							</tr>
      							<tr>
      								<th id="q1-sales" headers="q1" scope="col">매출액</th>
      								<th id="q1-change" headers="q1" scope="col">증감율</th>
      								<th id="q2-sales" headers="q2" scope="col">매출액</th>
      								<th id="q2-change" headers="q2" scope="col">증감율</th>
      							</tr>
      						</thead>
      						<tbody>
      							<tr>
      								<th id="seoul" headers="region" scope="row">서울</th>
      								<td headers="seoul q1 q1-sales">1,500만원</td>
      								<td headers="seoul q1 q1-change">+8%</td>
      								<td headers="seoul q2 q2-sales">1,650만원</td>
      								<td headers="seoul q2 q2-change">+10%</td>
      							</tr>
      							<tr>
      								<th id="busan" headers="region" scope="row">부산</th>
      								<td headers="busan q1 q1-sales">1,200만원</td>
      								<td headers="busan q1 q1-change">+5%</td>
      								<td headers="busan q2 q2-sales">1,300만원</td>
      								<td headers="busan q2 q2-change">+8%</td>
      							</tr>
      						</tbody>
      					</table>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>scope</code> 속성으로 행/열 헤더를 명확하게 지정합니다.
      				</dd>
      				<dd>
      					<code>id</code>와 <code>headers</code> 속성으로 복잡한 다중 헤더 구조를 명확히 연결합니다.
      				</dd>
      				<dd>
      					<code>&lt;caption&gt;</code>으로 표의 내용을 요약하여 제공합니다.
      				</dd>
      				<dd>
      					병합된 헤더(<code>colspan</code>, <code>rowspan</code>)에 따라 <code>id</code> 및 <code>headers</code>를 다단계로 연결합니다.
      				</dd>
      			</dl>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/2rx3gWdMSHA?si=9bNzsqWijd6PuIqu" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">표의 구성 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
