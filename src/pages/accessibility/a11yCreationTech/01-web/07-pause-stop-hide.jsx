...
const PAGE_DATA = {
  title: "자동 재생 금지 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '자동 재생 금지'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 인지장애 사용자, 청각과민 사용자, 비장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 자동으로 소리가 재생되지 않아야 한다.</b><br />
      			웹 페이지에서 자동으로 소리(동영상, 오디오, 음성, 배경 음악 등 콘텐츠가 제공하는 모든 소리)가 재생됨으로 인해
      			화면낭독프로그램 사용자가 콘텐츠를 인식하고 사용하는 데 방해받지 않아야 합니다.<br />
      			단, 3초 미만의 소리는 허용되며, 3초 이상 재생되는 소리는 제어할 수 있는 수단(멈춤, 일시정지, 음량 조절 등)을 함께 제공해야 합니다.
      			참고로, 플랫폼은 콘텐츠가 제공하는 배경음의 음량을 조절하더라도 화면낭독프로그램의 음량에는 영향을 주지 않아야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#audio-control" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">1.4.2 오디오 제어(Audio Control) (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/audio-control.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Audio Control</a>
      			<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/audio" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - HTML audio autoplay 속성</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			접근성 지침에서 자동 재생 금지를 준수하면,
      			사용자가 원하지 않는 소리나 영상으로 인해 갑작스러운 혼란이나 방해를 겪지 않게 되어 <b>보다 집중도 높은 정보 탐색 환경을 제공할 수 있습니다.</b><br />
      			특히 <b>화면 낭독 프로그램(Screen Reader)을 사용하는 사용자는 자동 재생되는 미디어로 인해 낭독이 중단되거나 겹쳐지는 불편을 겪을 수 있는데</b>,
      			이를 방지함으로써 <b>원활하고 방해 없는 콘텐츠 탐색이 가능해집니다.</b>
      			나아가 사용자가 <b>자신의 의도에 따라 미디어를 제어할 수 있어 접근성과 만족도가 함께 향상</b>됩니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			웹페이지에 접속했을 때 <b>사용자의 동의 없이 자동으로 재생되는 오디오 또는 영상 콘텐츠는 접근성을 심각하게 저해</b>합니다.
      			특히 스크린 리더 사용자나 집중이 필요한 사용자에게 불쾌감 또는 기능적 장애를 유발할 수 있으므로,
      			<b>자동 재생은 반드시 비활성화</b>하거나 <b>사용자가 제어할 수 있어야 합니다.</b>
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더 음성과 충돌</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">갑작스러운 소리에 혼란</p>
      				</li>
      				<li>
      					<p className="cell value">청각과민 사용자</p>
      					<p className="cell content">감각 과부하 유발 가능</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">데이터/배터리 낭비, 갑작스러운 소리로 불쾌감</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      ...
      <CodeBlock title="html - 자동 재생 금지" language="javascript" className="uk_gist_code_box">
      {`<video controls>
      ...
      <CodeBlock title="Vue - 자동 재생 금지" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 자동 재생 금지" language="javascript" className="uk_gist_code_box">
      {`function AudioPlayer() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;audio&gt;</code> 또는 <code>&lt;video&gt;</code> 태그에서 <code>autoplay</code> 속성이 있는가?
      			</li>
      			<li>
      				<code>autoplay</code>가 있는 경우, 소리가 없는 콘텐츠인가?
      			</li>
      			<li>
      				사용자 조작으로만 재생이 가능한가?
      			</li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				<code>&lt;audio&gt;</code>, <code>&lt;video&gt;</code> 요소에 <code>autoplay</code> 속성이 있는지 확인합니다.
      			</li>
      			<li>
      ...
      <CodeBlock title="자동 재생 금지 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<audio autoplay>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					사용자의 동의 없이 자동으로 오디오가 재생되어 <b>스크린 리더의 음성 출력을 방해</b>할 수 있습니다.
      				</dd>
      				<dd>
      					소리를 끄거나 멈출 수단이 없어 <b>통제 불가능한 사용자 경험</b>을 유발합니다.
      				</dd>
      			</dl>
      		</article>
      ...
      <CodeBlock title="자동 재생 금지 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<audio controls>
      						<source src="audio/background-music.mp3" type="audio/mpeg">
      						브라우저가 오디오를 지원하지 않습니다.
      					</audio>`}
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>controls</code> 속성을 통해 <b>사용자가 직접 재생 여부를 결정</b>할 수 있습니다.
      				</dd>
      				<dd>
      					<b>스크린 리더 사용자에게도 오디오가 방해되지 않으며</b>, 필요한 경우에만 재생하여 접근성을 보장합니다.
      				</dd>
      				<dd>
      					<b>의도하지 않은 소리 출력이 없어</b> 다양한 사용자 환경에서 쾌적한 이용이 가능합니다.
      				</dd>
      			</dl>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/RX7wfKwYA7Y?si=3BAw9PuKKpiAqEMH" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">자동 재생 금지 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
