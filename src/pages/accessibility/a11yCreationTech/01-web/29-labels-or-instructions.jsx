...
const PAGE_DATA = {
  title: "레이블 제공 | 웹 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '레이블 제공'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 인지장애인, 고령자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 사용자 입력에는 대응하는 레이블을 제공해야 한다.</b><br />
      			사용자 입력 근처에 사용법을 알려주는 레이블을 보조기술이 알 수 있도록 해당 콘트롤과 대응하여 제공해야 합니다.<br />
      			레이블과 사용자 입력 간의 관계를 보조기술이 인식할 수 있도록 대응시키지 않고 단순히 텍스트로만 제공할 경우,
      			보조기술은 해당 사용자 입력에 대한 레이블을 인식할 수 없습니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>성공 기준 3.3.2 (레벨 A) 요구 사항</strong>
      				<p>
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#labels-or-instructions" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 - 3.3.2 레이블 또는 지시사항 (Level A)</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			...
      			화면낭독프로그램을 사용하는 시각장애인에게 해당 콘트롤이 어떤 용도로 사용되는지를 알려줄 수 있으므로 잘못된 데이터의 입력을 방지할 수 있습니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			입력 필드나 양식 구성 요소는 시각적으로 식별 가능한 레이블뿐 아니라,
      			보조 기술 사용자에게도 인식될 수 있는 시멘틱한 레이블을 제공해야 합니다.
      			레이블 제공은 정보 전달과 오류 방지를 위한 중요한 접근성 항목입니다.
      		</p>
      		<ul className="mt_m dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>입력 목적의 명확화</strong>
      				<p>
      					사용자에게 어떤 정보를 입력해야 하는지 정확히 알려줍니다.
      				</p>
      			</li>
      			<li>
      				<strong>보조기술 호환성 보장</strong>
      				<p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더를 통해 필드의 이름을 듣고 이해함</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애인</p>
      					<p className="cell content">텍스트 안내로 어떤 정보를 입력해야 하는지 명확히 인지 가능</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">시각적 안내 부족 시 혼란을 줄 수 있음</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;label&gt;</code> 요소가 입력 필드와 연결되어 있는가? (<code>htmlFor=&quot;id&quot;</code> 와 <code>id=&quot;&quot;</code> 매칭)
      			</li>
      			<li>
      				시각적으로 레이블이 없을 경우, <code>aria-label</code> 또는 <code>aria-labelledby</code> 제공 여부
      			</li>
      			<li>
      				<code>placeholder</code>만으로 레이블을 대체하지 않았는가?
      			</li>
      			<li>
      				레이블은 구체적이며 명확한가?
      			</li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<strong>스크린 리더(NVDA, JAWS 등)</strong>로 입력 필드에 접근하여 필드명이 올바르게 출력되는지 확인합니다.
      			</li>
      			<li>
      				개발자 도구의 접근성 트리 또는 <code>name</code>, <code>role</code>, <code>value</code>를 확인합니다.
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				<code>aria-label</code>, <code>aria-labelledby</code> 활용률
      			</li>
      			<li>
      				스크린 리더 레이블 출력 성공률
      			</li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 – 올바른 레이블 제공</h3>

      			
      <CodeBlock title="html - 레이블 제공" language="javascript" className="uk_gist_code_box">
      {`<label for="email">이메일 주소</label>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">ARIA 사용 예시</h3>

      			<p className="mt_ms">
      				대체 방식으로 <code>aria-label</code>이나 <code>aria-labelledby</code>를 사용할 수도 있습니다.
      			</p>
      			<div className="mt_m indent">
      				<h4 className="ml_mn">aria-label</h4>

      				<p className="mt_s">
      					이 방식은 시각적 레이블이 필요 없을 때 유용하지만,
      					가급적 <code>&lt;label&gt;</code> 요소를 활용하는 것이 가장 접근성 친화적입니다.
      				</p>
      				
      <CodeBlock title="aria-label - 레이블 제공" language="javascript" className="uk_gist_code_box">
      {`<!-- aria-label -->
      					<input type="text" id="username" name="username" aria-label="사용자 이름">`}
      </CodeBlock>

      			</div>
      			<div className="mt_ml indent">
      				<h4 className="ml_mn">aria-labelledby</h4>

      				<ul className="mt_s dot_lst">
      					<li>
      						<code>aria-labelledby=&quot;username-label&quot;</code>로
      						<code>&lt;input&gt;</code> 요소가 <code>&lt;span&gt;</code> 요소의 텍스트를 레이블로 사용합니다.
      					</li>
      					<li>
      						스크린 리더는 <code>&lt;span&gt;</code>의 텍스트
      						<code>&quot;사용자 이름:&quot;</code>을 <code>&lt;input&gt;</code>의 레이블로 인식합니다.
      					</li>
      					<li>
      						이 방법은 시맨틱하게 <code>&lt;label&gt;</code> 태그를 사용하지 않고도 접근성을 확보할 수 있게 해줍니다.
      					</li>
      				</ul>
      				
      <CodeBlock title="aria-labelledby - 레이블 제공" language="javascript" className="uk_gist_code_box">
      {`<!-- aria-labelledby -->
      					<span id="username-label">사용자 이름:</span>
      ...
      <CodeBlock title="Vue - 레이블 제공" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 레이블 제공" language="javascript" className="uk_gist_code_box">
      {`function NameInput() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				<code>for</code> 속성과 <code>id</code> 속성의 연결이 일치하는가?
      			</li>
      		</ul>
      	</section>
      ...
      <CodeBlock title="레이블 제공 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<form>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;input&gt;</code> 요소에 <code>&lt;label&gt;</code>이 제공되지 않아 스크린 리더 사용자는 입력 필드의 목적을 알 수 없습니다.
      				</dd>
      				<dd>
      ...
      <CodeBlock title="레이블 제공 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<form>
      						<label for="username">사용자 이름:</label>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;label&gt;</code> 요소가 명시적으로 제공되어 스크린 리더가 해당 입력 필드의 용도를 정확히 읽어줄 수 있습니다.
      				</dd>
      				<dd>
      					<code>htmlFor=&quot;username&quot;</code>과 <code>id=&quot;username&quot;</code> 속성으로 레이블과 입력 필드를 연결합니다.
      				</dd>
      			</dl>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/MnvmNx0q1Qw?si=MDUnFh_j-diTF9F9" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">레이블 제공 | 웹 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
