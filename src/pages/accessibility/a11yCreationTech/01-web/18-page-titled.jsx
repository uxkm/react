...
const PAGE_DATA = {
  title: "제목 제공 | 웹 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '제목 제공'에 대해 소개합니다.",
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 페이지, 프레임, 콘텐츠 블록에는 적절한 제목을 제공해야 한다.</b><br />
      			페이지, 프레임, 콘텐츠 블록의 제목은 사용자가 웹 콘텐츠를 운용하기 쉽게 도와줍니다.
      			제목은 간단 명료해야 하며, 해당 페이지, 프레임, 콘텐츠 블록을 유추할 수 있도록 제공해야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				...
      				<p>
      					모든 웹 페이지가 해당 내용을 간단명료하게 기술한 제목을 포함하고 있을 경우, 사용자(예: 시각장애인, 지적장애인,
      					중증지체장애인 등)는 여러 개의 웹 페이지가 열려 있더라도 제목을 통해 웹 페이지를 선택하므로,
      					모든 웹 페이지에는 해당 페이지를 간단명료하게 설명한 제목을 제공해야 합니다.
      					또한, 웹 페이지는 유일하고 서로 다른(unique and exclusive) 제목을 제공해야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>팝업창 제목(title) 제공</strong>
      				<p>
      					팝업창에도 제목을 제공해야 합니다.
      				</p>
      			</li>
      			<li>
      				...
      				<p>
      					...
      					모든 프레임에 간단명료한 제목이 부여되면, 사용자(예: 시각장애인, 지적장애인, 중증지체장애인 등)는
      					프레임 제목을 통해 프레임의 선택, 이동 등이 가능하게 됩니다.
      					아무런 내용이 없는 프레임에도 '빈 프레임' 등과 같이 제목을 제공해야 합니다.
      				</p>
      			</li>
      			<li>
      				...
      				<p>
      					...
      					제목을 이용하여 콘텐츠 블록 간의 이동이 가능합니다.
      					그러나 본문이 없는 콘텐츠 블록에는 제목을 붙이지 않아야 합니다.
      				</p>
      			</li>
      			<li>
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#page-titled" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.2 페이지 제목 (Page Titled) (Level A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#headings-and-labels" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">2.4.6 제목 및 레이블 (Headings and Labels) (Level AA)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/page-titled.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Page Titles</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/HTML/Reference/Elements/title" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - HTML 제목 요소</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				웹사이트의 모든 웹 페이지에 각각 고유한 제목을 제공하면,
      				사용자가 동시에 여러 웹 페이지를 열어두었을 때도 페이지 제목을 통해 쉽게 식별하고 웹 페이지 간을 편리하게 이동할 수 있습니다.
      				이는 시각장애인, 지적장애인, 지체장애인 등 다양한 사용자가 웹사이트를 보다 효율적으로 사용할 수 있게 돕습니다.
      				따라서, 각 페이지는 해당 페이지만의 유일한 제목을 가져야 합니다.
      			</li>
      			<li>
      				웹 페이지를 구성하는 모든 프레임에 고유한 제목을 제공하면, 시각장애인, 지적장애인, 중증지체장애인 등
      				사용자는 프레임 제목을 통해 프레임 간을 쉽게 구별하고 편리하게 이동할 수 있습니다.
      				이를 위해, 페이지와 마찬가지로, 동일한 페이지 내의 모든 프레임은 각각 유일하고 서로 다른 프레임 제목을 가져야 합니다.
      			</li>
      		</ul>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">제목을 통해 구조를 탐색</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">제목을 보고 내용 예측 가능</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">섹션 간 빠른 이동 가능</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				모든 페이지에 <code>&lt;title&gt;</code> 요소가 있는가?
      			</li>
      			<li>
      				콘텐츠 블록에 적절한 제목 태그(<code>&lt;h1&gt;</code> ~ <code>&lt;h6&gt;</code>)가 포함되어 있는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				브라우저 탭에서 <code>&lt;title&gt;</code>을 확인하여 각 페이지의 제목이 적절한지 확인합니다.
      			</li>
      			<li>
      ...
      <CodeBlock title="html - 제목 제공" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      					<head>
      						<title>고객센터</title>
      ...
      <CodeBlock title="Vue - 제목 제공" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<main>
      							<h1>고객센터</h1>
      							<section>
      ...
      <CodeBlock title="React - 제목 제공" language="javascript" className="uk_gist_code_box">
      {`import { useEffect } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;title&gt;</code>이 페이지 내용을 대표하는가?
      			</li>
      			<li>
      				콘텐츠 블록마다 <code>&lt;h1&gt;</code> ~ <code>&lt;h6&gt;</code> 구조가 논리적인가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_red">미준수 사례<i> (제목과 콘텐츠 내용이 다른 경우)</i></h3>

      			
      <CodeBlock title="제목 제공 - 미준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      								<meta charset="UTF-8">
      								<meta name="viewport" content="width=device-width, initial-scale=1.0">
      								<title>홈페이지</title> <!-- 제목과 실제 콘텐츠 내용이 일치하지 않음 -->
      						</head>
      						<body>
      								<h1>웹 접근성에 대해 배워봅시다</h1> <!-- 콘텐츠와 제목이 불일치 -->
      								<p>이 페이지는 웹 접근성 준수 방법에 대해 설명하는 페이지입니다.</p>
      						</body>
      					</html>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;title&gt;</code> 태그에는 <code>&quot;홈페이지&quot;</code>라는 제목이 제공되고 있지만,
      					실제 페이지 콘텐츠는 &quot;웹 접근성에 대해 배워봅시다&quot;라는 내용을 담고 있습니다.
      				</dd>
      				<dd>
      					사용자가 이 페이지를 열면, 브라우저 탭에 <code>&quot;홈페이지&quot;</code>라고만 표시되어 페이지의 실제 내용을 정확하게 파악하기 어려워집니다.
      					특히 스크린 리더 사용자는 페이지의 주요 주제를 알기 어렵습니다.
      				</dd>
      				<dd>
      ...
      <CodeBlock title="제목 제공 - 준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      								<meta charset="UTF-8">
      								<meta name="viewport" content="width=device-width, initial-scale=1.0">
      								<title>웹 접근성 안내</title> <!-- 제목과 콘텐츠 내용이 일치함 -->
      						</head>
      						<body>
      								<h1>웹 접근성에 대해 배워봅시다</h1> <!-- 콘텐츠와 제목이 일치 -->
      								<p>이 페이지는 웹 접근성 준수 방법에 대해 설명하는 페이지입니다.</p>
      						</body>
      					</html>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;title&gt;</code> 태그에 &quot;웹 접근성 안내&quot;라는 제목을 추가하여 페이지의 주제를 명확하게 나타냄.
      				</dd>
      				<dd>
      					사용자는 브라우저 탭에서 &quot;웹 접근성 안내&quot;라는 제목을 보고 이 페이지의 주제를 쉽게 이해할 수 있습니다.
      					또한 스크린 리더 사용자도 페이지 내용을 쉽게 파악할 수 있습니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/xuGoPImMXgU?si=iHy_LIFUMVsdnhv6" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">제목 제공 | 웹 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
