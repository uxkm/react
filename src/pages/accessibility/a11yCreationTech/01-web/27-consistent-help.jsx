...
const PAGE_DATA = {
  title: "찾기 쉬운 도움 정보 | 웹 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '찾기 쉬운 도움 정보'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단말기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 인지장애인, 시각장애인, 고령자, 비장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 도움 정보가 제공되는 경우, 각 페이지에서 동일한 상대적인 순서로 접근할 수 있어야 한다.</b><br />
      			단일 페이지 웹 애플리케이션 또는 웹 페이지 세트에서 다음 도움 정보 중 하나 이상의 도움 정보가 제공되면,
      			최소한 하나의 도움 정보는 해당 페이지에서 동일한 상대적인 순서대로 제공되어야 합니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				...
      				<ul className="mt_sm indent_small dot_lst dot_lst_inner">
      					<li>전화번호, 이메일 주소, 운영 시간 등의 인적 연락처 정보</li>
      					<li>메신저, 채팅, 문의 게시판, SNS 등과 같은 직접 상담 연결</li>
      					<li>자주 묻는 질문, 사용 방법, 고객 지원 페이지와 같은 셀프 서비스</li>
      					<li>챗봇과 같은 완전 자동화 된 지원 방식</li>
      				</ul>
      			</li>
      			<li>
      				<strong>동일한 상대적인 순서</strong>
      				<p>
      					웹 사이트 각 페이지에서 도움 정보가 시각적 위치뿐만 아니라 코드 구조(마크업 순서) 상에서도 일관되게 배치되는 것을 의미합니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#consistent-help" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">3.2.6 찾기 쉬운 도움 정보 (Level AAA)</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			도움 정보가 상대적으로 동일한 위치에 제공되지 않으면, 사용자는 원하는 도움 정보를 찾는 데 어려움을 겪을 수 있습니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			웹사이트나 웹 애플리케이션에서 사용 설명서, 고객센터 링크, 도움말 콘텐츠 등 사용자 지원 정보가 존재하는 경우,
      			해당 정보는 일관된 위치에 제공되어야 하며, 모든 페이지에서 동일한 방식으로 접근 가능해야 합니다.
      		</p>
      	...
      	<section className="indent mt_xxl">
      		<h2 className="ml_mn" data-conlist="false">도움 정보 위치의 비일관성 문제</h2>
      		

      		<p className="mt_l">
      			<b>
      				사용자가 필요한 도움 정보를 찾으려 할 때,
      				여러 페이지에서 일관된 위치에 제공하지 않으면 아래와 같문 문제가 발생할 수 있습니다.
      			</b>
      		</p>
      		<ul className="mt_m dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>화면 낭독 프로그램 사용자</strong>
      				<p>
      					페이지마다 위치가 바뀌면 매번 페이지 전체를 탐색해서 다시 찾아야 하므로 시간과 노력이 크게 듭니다.
      				</p>
      			</li>
      			<li>
      				<strong>화면 확대를 사용하는 저시력자</strong>
      				<p>
      					페이지마다 다른 위치에 있는 도움 정보를 찾기 위해 화면을 계속 스크롤하거나 이동하며 탐색해야 하므로 피로도가 증가합니다.
      				</p>
      			</li>
      			<li>
      				<strong>인지 능력에 제한이 있는 사용자</strong>
      				<p>
      					위치가 매번 바뀌면 새로운 정보를 기억해야 하고, 원래 하려던 작업을 잊을 수도 있습니다.
      				</p>
      			</li>
      			<li>
      				<strong>학습 능력에 제한이 있는 사용자</strong>
      				<p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">반복된 UI 패턴으로 도움말 접근성 향상</p>
      				</li>
      				<li>
      					<p className="cell value">시각장애인</p>
      					<p className="cell content">스크린 리더 탐색 시 위치 예측 가능</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">학습된 구조 유지로 인지적 부담 완화</p>
      				</li>
      				<li>
      					<p className="cell value">비장애 사용자</p>
      					<p className="cell content">일관된 도움말 위치는 사용자 경험 개선에 기여</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">html 예시 – 헤더 영역에 일관된 도움말 위치</h3>

      			
      <CodeBlock title="html - 찾기 쉬운 도움 정보" language="javascript" className="uk_gist_code_box">
      {`<header>
      						<nav>
      							<ul>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">Vue 예시 – Layout 구조에 포함</h3>

      			
      <CodeBlock title="Vue - 찾기 쉬운 도움 정보" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<header>
      							<nav>
      								<ul>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">React 예시 – 공통 Header 컴포넌트에 도움말 위치 고정</h3>

      			
      <CodeBlock title="React - 찾기 쉬운 도움 정보" language="javascript" className="uk_gist_code_box">
      {`function Header() {
      						return (
      							<header>
      								<nav>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			...
      			<div className="mt_ml indent">
      				<h4 className="ml_mn">접근 시마다 다른 곳에 실시간 채팅 버튼 노출</h4>

      				<figure className="img_figure mt_m">
      					<img src={`${IMG.A11Y_TECH_W_U}/33/img-consistent-help03.png`} alt="" />
      					<figcaption>
      				...
      				<dl className="mt_ms dl_lst">
      					...
      					<dd>
      						페이지가 변경되어도 실시간 채팅 버튼은 고정된 영역에 배치하고,
      						마크업 순서뿐 아니라 시각적으로도 동일한 위치에 유지될 수 있도록 제공합니다.<br />
      			...
      			<div className="mt_l indent">
      				<h4 className="ml_mn">인적 연락처 정보가 서로 다른 위치에 제공</h4>
      				<figure className="img_figure mt_m">
      					<img src={`${IMG.A11Y_TECH_W_U}/33/img-consistent-help04.png`} alt="" />
      					<figcaption>
      						[출처 : 웹 접근성을 고려한 콘텐츠 제작기법 개정판]
      					</figcaption>
      				</figure>
      				<dl className="mt_ms dl_lst">
      					<dt className="font-14-important t_black">개선 방법</dt>
      					<dd>
      						모든 페이지에서 연락처 정보는 동일한 시각적,
      						마크업 위치에 유지되도록 푸터 첫 번째 항목으로 “고객센터 연락처”를 고정 배치하여 제공합니다.
      					</dd>
      				</dl>
      			</div>
      		</article>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml indent">
      				<h4 className="ml_mn">연락처를 일관된 위치에 제공</h4>
      				<figure className="img_figure mt_m">
      					<img src={`${IMG.A11Y_TECH_W_U}/33/img-consistent-help01.png`} alt="" />
      					<figcaption>
      						[출처 : 웹 접근성을 고려한 콘텐츠 제작기법 개정판]
      					</figcaption>
      				</figure>
      			...
      			<div className="mt_l indent">
      				<h4 className="ml_mn">자동화된 챗봇 버튼의 통일된 배치</h4>
      				<figure className="img_figure mt_m">
      					<img src={`${IMG.A11Y_TECH_W_U}/33/img-consistent-help02.png`} alt="" />
      					<figcaption>
      						[출처 : 웹 접근성을 고려한 콘텐츠 제작기법 개정판]
      					</figcaption>
      				</figure>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/7qlDWDXnwsc?si=Srg27nDRtv6HiWJY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : 리베하얀
      		</p>
      ...
      <footer className="reference_box">
      	<strong className="tit">찾기 쉬운 도움 정보 | 웹 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
