...
const PAGE_DATA = {
  title: "오류 정정 | 웹 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '오류 정정'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 인지장애인, 시각장애인, 고령자, 비 장애인 사용자",
}

function ErrorSuggestionPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 입력 오류를 정정할 수 있는 방법을 제공해야 한다.</b><br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#non-text-content" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WCAG 2.2 Quick Reference - Non-text Content</a>
      		</p>
      	</section>
      	

      	<section className="indent mt_xxl">
      		<h2 className="ml_mn" data-conlist="false">사용자 입력 오류 안내</h2>

      		<p className="mt_l">
      			온라인 서식에서 오류가 발생했을 경우, 사용자에게 오류가 발생한 항목과 그 이유를 명확하게 안내해야 합니다.
      			예를 들어 필수 입력 항목이 누락된 경우, 어떤 항목이 누락되었는지를 구체적으로 알려주어야 합니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				입력 오류에 대한 <b>자세한 텍스트 설명을 제공하는 것</b>은 학습장애가 있는 사용자가 서식을 올바르게 작성하는 데 큰 도움이 됩니다.
      				오류가 발생한 위치에 <b>단순히 시각적인 표시만 제공하는 경우</b>,
      				시각장애인이나 저시력 사용자는 오류 위치에 도달하기 전까지 문제를 인식하기 어렵습니다.
      				따라서, <b>오류 내용을 먼저 텍스트로 설명하거나</b>,
      				프로그램적으로 <b>초점을 오류 위치로 이동시킨 뒤 오류 설명을 제공하는 방식</b>이 보다 효과적입니다.
      			</li>
      			<li>
      				실수로 인해 빚어지는 심각한 결과 또는 과실을 피하기 위해 오류 정정에 필요한 정보나 수단을 제공하는 것은
      				장애인뿐만 아니라 비장애인에게도 도움이 됩니다.
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			사용자가 양식 또는 입력 필드에서 오류를 발생시켰을 때,
      			이를 인지하고 수정할 수 있도록 적절한 오류 메시지와 정정 방법을 제공해야 합니다.
      			오류가 발생한 위치와 원인을 명확히 제시함으로써 사용자의 인지적 부담을 줄이고 접근성을 확보할 수 있습니다.
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">실수 인식과 수정이 어려움 → 구체적인 피드백 필요</p>
      				</li>
      				<li>
      					<p className="cell value">시각장애인</p>
      					<p className="cell content">오류 위치 및 내용을 스크린 리더로 안내받아야 함</p>
      				</li>
      				<li>
      					<p className="cell value">고령자</p>
      					<p className="cell content">메시지 이해가 어려운 경우 많음, 단순하고 명확한 안내 필요</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 – 오류 메시지 제공</h3>

      			
      <CodeBlock title="html - 오류 정정" language="javascript" className="uk_gist_code_box">
      {`<form>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">ARIA 예시 – 오류 연결</h3>

      			
      <CodeBlock title="ARIA - 오류 정정" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="Vue - 오류 정정" language="html" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="React - 오류 정정" language="html" className="uk_gist_code_box">
      {`function Form() {
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">오류 처리 방법</h3>

      			<p className="mt_ms">
      				사용자가 입력해야 하는 내용에 대해 쉽게 안내해주어야 합니다.
      			</p>
      			<figure className="img_figure mt_ms">
      				<img src={`${IMG.A11Y_TECH_W_U}/34/img-error01.png`} alt="" />
      				<figcaption>
      			...
      			<p className="mt_m">
      				만일 사용자가 잘못 입력했을 경우에는 어느 부분에서 어떤 오류가 났는지 알려 주어야 하고
      				이를 정정할 수 있는 방법을 제공해야 합니다.
      			</p>
      			<figure className="img_figure mt_ms">
      				<img src={`${IMG.A11Y_TECH_W_U}/34/img-error02.png`} alt="" />
      				<figcaption>
      					[출처 : 네이버 접근성 정보 접근성 지침 이해하기 - 오류 정정]
      				</figcaption>
      			</figure>
      ...
      <CodeBlock title="오류 정정 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<form>
      						<label for="email">이메일:</label>
      						<input type="email" id="email" name="email" required>
      						<button type="submit">제출</button>
      ...
      <CodeBlock title="오류 정정 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<form aria-describedby="email-error">
      						<label for="email">이메일:</label>
      						<input type="email" id="email" name="email" required aria-invalid="false">
      						<span id="email-error" class="error-message" role="alert" style="display:none;">올바른 이메일 형식을 입력하세요.</span>
      						<button type="submit">제출</button>
      					</form>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>aria-invalid=&quot;true&quot;</code> 속성을 사용해 오류가 발생한 입력 필드를 화면 리더가 인식할 수 있도록 합니다.
      				</dd>
      				<dd>
      					오류 메시지는 <code>aria-describedby</code>를 사용하여 해당 필드와 연관되도록 합니다.
      				</dd>
      				<dd>
      					오류 메시지가 <code>role=&quot;alert&quot;</code>로 설정되어 있어 오류 발생 시 자동으로 화면 리더가 이를 읽을 수 있습니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/HbaDhv-q0d0?si=Krd7ebfyeeDWErOc" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">오류 정정 | 웹 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
...
export default ErrorSuggestionPage
