...
const PAGE_DATA = {
  title: "기본 언어 표시 | 웹 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '기본 언어 표시'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 다국어 사용자, 외국인 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 주로 사용하는 언어를 명시해야 한다.</b><br />
      			웹 브라우저는 웹 페이지에 포함된 텍스트 콘텐츠의 언어 정보를 기준으로 화면에 표시하거나, 이를 보조기술에 전달합니다.<br />
      			다국어를 지원하는 화면 낭독 프로그램을 사용하는 경우에는,
      			해당 언어 정보가 프로그램에 전달되어야 정확한 발음으로 읽을 수 있습니다.<br />
      			따라서 웹 페이지에서는 제공하는 콘텐츠에 적용되는 기본 언어를 반드시 명시하여,
      			사용자에게 올바른 정보 전달과 원활한 접근성을 보장할 수 있습니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#language-of-page" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">3.1.1 문서 언어 (Level A)</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			기본 언어가 명확히 표시되면, 사용자는 페이지의 콘텐츠를 보다 쉽게 이해할 수 있습니다.<br />
      			특히, 스크린 리더와 같은 보조 기술을 사용하는 사용자에게 언어 설정이 정확히 전달되면,
      			해당 언어의 음성 피드백을 통해 콘텐츠를 효과적으로 파악할 수 있습니다.
      			화면 낭독 프로그램과 점역 프로그램과 같은 보조기술은 웹 페이지의 기본 언어를 인식하여
      			자동적으로 음성 모듈을 선택하거나 해당 언어에 적합한 점역 방법을 선택할 수 있는 편리함이 있습니다.<br />
      			또한, 다국적 사용자나 다양한 언어를 사용하는 사람들이 사이트를 탐색할 때 혼란을 줄이고,
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			웹 문서 또는 웹 애플리케이션은 콘텐츠의 기본 언어를 HTML 마크업 내에서 명시해야 합니다.
      			이는 보조기술(스크린 리더 등)이 정확한 발음과 언어 처리를 수행할 수 있도록 돕기 위한 핵심 요소입니다.
      		</p>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더로 언어 인식 → 올바른 발음 제공</p>
      				</li>
      				<li>
      					<p className="cell value">다국어 사용자</p>
      					<p className="cell content">언어 혼용 시 발음 구분 불가능 시 이해도 저하</p>
      				</li>
      				<li>
      					<p className="cell value">외국인 사용자</p>
      					<p className="cell content">올바른 콘텐츠 번역과 해석을 위한 기반 제공</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;html lang=&quot;ko&quot;&gt;</code> 또는 해당 언어 코드가 명시되어 있는가?
      			</li>
      			<li>
      				콘텐츠 내 다른 언어를 사용하는 요소에 <code>lang</code> 속성이 명시되어 있는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				페이지 소스 확인 → <code>&lt;html lang=&quot;ko&quot;&gt;</code> 또는 다른 언어 코드 존재 여부를 확인합니다.
      			</li>
      			<li>
      				콘텐츠 내에 다국어 콘텐츠가 포함되어 있다면 <code>lang=&quot;en&quot;</code>,
      				<code>lang=&quot;ja&quot;</code> 등으로 개별 설정되었는지 확인합니다.
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 전체 문서 언어 설정</h3>

      			
      <CodeBlock title="html - 기본 언어 표시" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<meta charset="UTF-8">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">콘텐츠 일부 다국어 사용 시</h3>

      			
      <CodeBlock title="콘텐츠 일부 다국어 사용 시 예제" language="javascript" className="uk_gist_code_box">
      {`<p>
      						웹 접근성은 <span lang="en">Accessibility</span>를 의미합니다.
      					</p>`}
      </CodeBlock>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">Vue 예시 (lang은 index.html에서 지정)</h3>

      			
      <CodeBlock title="Vue - 기본 언어 표시" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<meta charset="UTF-8" />
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">React 예시 (index.html 설정)</h3>

      			
      <CodeBlock title="React - 기본 언어 표시" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<meta charset="UTF-8" />
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				<code>&lt;html&gt;</code> 태그에 <code>lang</code> 속성이 선언되어 있는가?
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				HTML 코드 검사 시 <code>lang</code> 속성 확인합니다.
      			</li>
      			<li>
      				다국어 텍스트 영역에 <code>lang</code> 속성 적용 여부를 확인합니다.
      			</li>
      			<li>
      	...
      	<section className="indent mt_xxl"                  >
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_red">미준수 사례 (기본 언어 표시 미설정)</h3>

      			
      <CodeBlock title="기본 언어 표시 - 미준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html>
      						<head>
      							<title>웹 페이지</title>
      						...
      						<body>
      							<p>
      								이 페이지는 여러 언어를 지원하지 않습니다.
      								기본 언어를 지정하지 않아 화면 낭독 프로그램이 언어를 인식할 수 없습니다.
      							</p>
      						</body>
      					</html>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>lang</code> 속성 미설정으로, 화면 낭독 프로그램이나 다른 보조 기술이 페이지의 기본 언어를 알 수 없어
      					적절한 음성 모듈을 선택하거나 텍스트의 언어에 맞는 점역 방법을 적용할 수 없습니다.
      				</dd>
      			</dl>
      		</article>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">준수 사례 (기본 언어 표시 설정)</h3>

      			
      <CodeBlock title="기본 언어 표시 - 준수 사례" language="html" className="uk_gist_code_box">
      {`<!DOCTYPE html>
      					<html lang="ko">
      						<head>
      							<title>웹 페이지</title>
      						...
      						<body>
      							<p>
      								이 페이지는 한국어로 작성되었습니다.
      								화면 낭독 프로그램과 점역 프로그램이 페이지의 언어를 인식하여
      								적절한 음성 모듈과 점역 방법을 사용할 수 있습니다.
      							</p>
      						</body>
      					</html>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;html&gt;</code> 태그에 <code>lang=&quot;ko&quot;</code>를 설정하여 페이지의 기본 언어가 &quot;한국어&quot;임을 명확히 지정합니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/Pujf4gdBu5M?si=tihdpdlVKFcbGsd2" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">기본 언어 표시 | 웹 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
