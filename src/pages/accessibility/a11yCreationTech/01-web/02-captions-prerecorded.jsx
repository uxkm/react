...
const PAGE_LAYOUT = {
  mainClass: "captions-prerecorded",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "자막 제공 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '자막 제공'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성",
}

function CaptionsPrerecordedPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 멀티미디어 콘텐츠에는 자막, 대본 또는 수어를 제공해야 한다.</b><br />
      			멀티미디어 콘텐츠를 장애인도 비장애인과 동등하게 인식할 수 있도록 제작하려면, 자막, 대본 또는 수어를 제공해야 합니다.
      			여기서 가장 중요한 요소는 <b>멀티미디어 콘텐츠와 동등한 내용을 제공하는 것</b>입니다.<br />

      			가장 바람직한 방법은 폐쇄자막을 오디오와 동기화하여 제공하는 것입니다.
      			대사 없이 영상만 제공하는 경우에는 <strong>화면 해설(텍스트, 오디오, 대본)</strong>을 제공해야 하며,
      			음성만 제공하는 경우에도 <b>자막, 대본 또는 수어</b>를 반드시 함께 제공해야 합니다.<br />

      			또한, 자막·대본·수어는 단순 번역이 아닌 <b>콘텐츠에 포함된 음성의 문맥과 동등한 수준</b>을 갖춰야 합니다.
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l weight-600 t_blue font-16-important">
      		...
      		<p className="mt_ml success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#captions-prerecorded" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link before_none">1.2.2 캡션(사전 녹화된 콘텐츠) (Level A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#audio-only-and-video-only-prerecorded" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link before_none">1.2.1 오디오 전용 및 영상 전용 (Level A)</a>
      			<a href="https://www.w3.org/TR/WCAG22/#audio-description-or-media-alternative-prerecorded" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link before_none">1.2.3 오디오 설명 또는 대본 (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/captions-prerecorded.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link before_none">WAI - Understanding Captions</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/HTML/Element/track" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link before_none">MDN - HTML 요소</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			...
      			<li>
      				장애인이 아닌 경우에도 자막이 포함된 영상 매체를 다양한 방법으로 활용할 수 있습니다.<br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			영상 콘텐츠에는 <b>청각 장애 사용자 또는 소리를 들을 수 없는 환경의 사용자</b>를 위해 자막, 대본(script), 수어 등의 <b>대체 수단을 제공</b>해야 합니다.
      			자막은 음성 정보뿐만 아니라 중요한 소리 정보(예: 박수, 경고음 등)도 포함해야 하며, 사용자에게 명확하게 전달되어야 합니다.
      		</p>
      		<ul className="mt_ms dot_lst gap-column-important-sm">
      			<li>청각장애 사용자에게 음성 콘텐츠의 의미 전달</li>
      			<li>지하철, 도서관 등 음소거 환경에서도 영상 시청 가능</li>
      			<li>자막은 외국어 콘텐츠의 이해력 향상에도 도움</li>
      			<li>대본, 수어 등 다양한 수단은 접근성 선택권 확대</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					<p className="cell value">청각장애 사용자</p>
      					<p className="cell content">영상 속 대사, 설명 등 이해 가능</p>
      				</li>
      				<li>
      					<p className="cell value">외국어 청취 어려운 사용자</p>
      					<p className="cell content">자막을 통해 이해도 향상</p>
      				</li>
      				<li>
      					<p className="cell value">환경적 제약 사용자</p>
      					<p className="cell content">음소거 환경, 소리 차단 기기 사용 시 유용</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>영상 콘텐츠에 자막이 제공되는가?</li>
      			<li>자막이 음성 정보뿐만 아니라 중요한 소리 정보도 포함하는가?</li>
      			<li>자막이 시각적으로 명확하게 표현되는가?</li>
      			<li>대본 또는 수어 영상이 함께 제공되는가?</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">html 예시 - &lt;track&gt; 요소 사용</h3>

      			
      <CodeBlock title="html - 자막 제공" language="javascript" className="uk_gist_code_box">
      {`<video controls>
      ...
      <CodeBlock title="Vue - 자막 제공" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<video controls>
      ...
      <CodeBlock title="React - 자막 제공" language="javascript" className="uk_gist_code_box">
      {`function VideoWithCaptions() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>
      				영상에서 <code>&lt;track&gt;</code> 요소 또는 별도 대본 링크 존재 여부를 확인합니다.
      			</li>
      			<li>
      				음성 정보와 자막 싱크를 확인합니다.
      			</li>
      ...
      <CodeBlock title="자막 제공 - 미준수 사례" language="javascript" className="uk_gist_code_box">
      {`<video controls width="600">
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;track&gt;</code> 요소가 누락되어 있어 자막이 제공되지 않습니다.
      				</dd>
      				<dd>
      ...
      <CodeBlock title="자막 제공 - 준수 사례" language="javascript" className="uk_gist_code_box">
      {`<video controls width="600">
      						<source src="example-video.mp4" type="video/mp4">
      						<track src="captions.vtt" kind="subtitles" srclang="ko" label="한국어 자막" default>
      						브라우저가 video 태그를 지원하지 않습니다.
      					</video>`}
      </CodeBlock>
      			...
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd>
      					<code>&lt;track&gt;</code> 요소를 통해 자막 파일을 명시적으로 연결합니다.
      				</dd>
      				<dd>
      					<code>kind=&quot;subtitles&quot;</code>로 자막 유형을 정의하고, <code>srclang=&quot;ko&quot;</code>로 언어를 지정합니다.
      				</dd>
      				<dd>
      					<code>label=&quot;Korean&quot;</code>은 사용자가 자막을 선택할 때 식별할 수 있도록 합니다.
      				</dd>
      				<dd>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/oNnlDFOL-P4?si=VXzICisHy0Nm9A8G" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">자막 제공 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default CaptionsPrerecordedPage
