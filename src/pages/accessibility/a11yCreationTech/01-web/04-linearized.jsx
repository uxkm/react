...
const PAGE_DATA = {
  title: "콘텐츠의 선형구조 | 웹 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "웹 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 웹 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 웹 접근성 콘텐츠 제작 기법 중 하나인 '콘텐츠의 선형구조'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 웹 접근성, 웹 접근성 콘텐츠 제작 기법, 한국형 웹 콘텐츠 접근성 지침 2.2, WCAG2.2, KWCAG2.2, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, Jaws, NVDA, 센스리더, Sense Reader, 시각장애인, 키보드 사용자, 인지장애 사용자",
}

function LinearizedPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침 : 콘텐츠는 논리적인 순서로 제공해야 한다.</b><br />
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l success_criteria">
      			<a href="https://www.w3.org/TR/WCAG22/#meaningful-sequence" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">1.3.2 의미 있는 순서 (Meaningful Sequence) (Level A)</a>
      			<a href="https://www.w3.org/WAI/WCAG22/Understanding/meaningful-sequence.html" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">WAI - Understanding Meaningful Sequence</a>
      			<a href="https://developer.mozilla.org/ko/docs/Web/CSS/CSS_positioned_layout" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500 box_link external before_none">MDN - CSS Positioning 참고</a>
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			콘텐츠는 시각적 배치와 무관하게, <b>스크린 리더나 키보드 사용자가 순차적으로 접근할 때도 의미가 유지되도록 논리적인 순서로 구성</b>되어야 합니다.
      			CSS나 JavaScript를 통해 시각적으로 재배열된 콘텐츠도 <b>HTML 코드 상의 순서는 논리적</b>이어야 합니다.
      		</p>
      		<ul className="mt_ms dot_lst gap-column-important-sm ">
      			<li>
      				시각적으로는 이해할 수 있어도, <b>스크린 리더는 문서 순서대로 콘텐츠를 읽습니다.</b>
      			</li>
      			<li>
      				CSS Flex/Grid 등으로 배치가 변경되더라도 <b>DOM 순서가 의미를 유지</b>해야 합니다.
      			</li>
      			<li>
      				논리적인 콘텐츠 흐름은 사용자의 <b>이해도를 향상시키고 오독을 방지하는 데 기여</b>합니다.
      			</li>
      		</ul>
      	</section>
      		...
      		<div className="table_summary value_200 mt_l">
      			...
      			<ul className="lst_bd">
      				<li>
      					...
      					<p className="cell content">스크린 리더 사용 시 순서대로 콘텐츠 탐색</p>
      				</li>
      				<li>
      					<p className="cell value">키보드 사용자</p>
      					<p className="cell content">Tab 순서대로 기능과 정보에 접근</p>
      				</li>
      				<li>
      					<p className="cell value">인지장애 사용자</p>
      					<p className="cell content">콘텐츠 흐름에 따라 정보를 처리</p>
      				</li>
      			</ul>
      		</div>
      	</section>
      ...
      <CodeBlock title="html - 콘텐츠의 선형구조" language="javascript" className="uk_gist_code_box">
      {`<h2>상품 소개</h2>
      					<p>이 상품은...</p>
      					<button>구매하기</button>`}
      </CodeBlock>
      ...
      <CodeBlock title="Vue - 콘텐츠의 선형구조" language="javascript" className="uk_gist_code_box">
      {`<template>
      						<section>
      							<h2>프로필</h2>
      							<p>소개 내용</p>
      ...
      <CodeBlock title="React - 콘텐츠의 선형구조" language="javascript" className="uk_gist_code_box">
      ...
      <UkEditorTarget target="a11yCreationTech/web/04-linearized_1.html" className="uk_editor min_height_530 mb_result_height_600" mode="htmlmixed" theme="ayu-mirage" browser="default" result minHeight="530px" mbResultHeight="600px" />
      </Suspense>
      </div>
      			<dl className="dl_dot_lst mt_ms">
      				...
      				<dd></dd>
      				<dd>
      					스크린 리더나 키보드 사용자는 &quot;제목 → 공지사항 목록 → 더보기&quot; 순서로 탐색할 수 있도록 콘텐츠의 DOM 구조를 정의해야 하지만,
      					실제 화면에 보여지는 시각적 순서에 따라 DOM이 작성되어 있어 정보 전달의 흐름이 왜곡될 수 있습니다.
      				</dd>
      				<dd>
      					이로 인해 스크린 리더 사용자는 공지사항 목록을 읽기 전에 &quot;더보기&quot; 링크에 먼저 도달하게 되어 맥락을 이해하기 어렵고,
      					키보드 사용자는 콘텐츠를 논리적인 흐름대로 탐색하기 어렵게 됩니다.<br />
      					접근성을 고려하여 시맨틱 구조와 DOM의 순서를 사용자 경험에 맞게 재구성하는 것이 바람직합니다. 시각적 디자인은 CSS로 조정하되,
      					논리적 탐색 순서는 의미 중심으로 유지하는 것이 좋습니다.
      				</dd>
      			</dl>
      		</article>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="view_editor edit_code mt_m">
      <Suspense fallback={<EditorFallback />}>
      <UkEditorTarget target="a11yCreationTech/web/04-linearized_2.html" className="uk_editor min_height_530 mb_result_height_600" mode="htmlmixed" theme="ayu-mirage" browser="default" result minHeight="530px" mbResultHeight="600px" />
      </Suspense>
      </div>
      			<dl className="dl_dot_lst mt_ms">
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/7T3J8BQ0NwQ?si=ME_KcrKQcgrJbVYl" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      ...
      <footer className="reference_box">
      	<strong className="tit">콘텐츠의 선형구조 | 웹 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
