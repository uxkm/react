...
const PAGE_DATA = {
  title: "알림 기능 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 접근성 콘텐츠 제작 기법 중 하나인 '알림 기능'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 대체 텍스트, 비 텍스트 콘텐츠, accessibilityLabel, contentDescription, 보조기술과의호환성, 접근성 테스트 도구 활용 점검방법, 스크린 리더, VoiceOver, TalkBack, 알림 기능, 상태 메시지, 진동 피드백, 시각적 알림",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(충분한 시간 제공) : 작업 흐름을 방해하는 인터럽션은 지연·묶음·해제 등 제어 수단을 제공하는가?</b><br />
      			인터럽션은 작업 중 갑자기 나타나는 팝업, 권한 재요청, 평가 유도, 프로모션 배너처럼 사용자의 맥락을 끊는 요소입니다.
      			반복적이거나 예고 없는 인터럽션은 인지 부담을 높이고 작업 실패를 유발할 수 있으므로, 사용자가 시점을 제어할 수 있게 설계해야 합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#interruptions" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Interruptions</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			인터럽션이 빈번하거나 사용자가 제어할 수 없으면 현재 진행 중인 입력·결제·작성 흐름이 중단됩니다.
      			특히 인지 장애 사용자, 보조기술 사용자, 고령자는 갑작스러운 문맥 전환에 더 취약하므로,
      			중요하지 않은 인터럽션은 지연하거나 묶어서 제공하고 즉시 닫기/다시 보지 않기 같은 제어 수단을 제공해야 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>인지 장애 사용자</strong><p>예고 없는 팝업·화면 전환으로 현재 작업 맥락을 잃기 쉬운 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>인터럽션으로 초점이 강제로 이동하면 이전 작업 위치를 놓치기 쉬운 사용자.</p></li>
      			<li><strong>운동 장애·스위치 사용자</strong><p>작은 닫기 버튼이나 짧은 노출 시간 때문에 인터럽션 해제가 어려운 사용자.</p></li>
      			<li><strong>고령 사용자</strong><p>반복 알림·광고성 배너로 피로가 빠르게 누적되어 작업을 포기할 수 있는 사용자.</p></li>
      			<li><strong>모든 사용자</strong><p>입력·결제·인증 같은 핵심 작업 중 불필요한 인터럽션에 의해 실수 가능성이 높아지는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>표시 시점 제어</strong><p>핵심 작업(입력·결제) 중 비필수 인터럽션은 지연하거나 종료 후 표시되는가?</p></li>
      			<li><strong>닫기/미루기 제공</strong><p>인터럽션에 즉시 닫기, 나중에 보기, 다시 보지 않기 같은 선택지가 있는가?</p></li>
      			<li><strong>반복 빈도 제한</strong><p>동일 인터럽션이 짧은 시간에 반복 노출되지 않도록 빈도·쿨다운 정책이 있는가?</p></li>
      			<li><strong>초점 유지</strong><p>인터럽션 종료 후 포커스가 이전 작업 위치로 복귀하고 입력값이 보존되는가?</p></li>
      			<li><strong>우선순위 분리</strong><p>보안·오류 등 필수 인터럽션과 마케팅성 인터럽션을 구분해 처리하는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst info_lst gap-column-important-ms reference">
      				<li>
      					...
      					<p>
      						iOS의 VoiceOver 기능을 활성화한 후, 알림 메시지가 음성으로 전달되는지 확인합니다.<br />
      						예시) 파일 업로드 성공 시, <mark>&quot;파일이 성공적으로 업로드되었습니다.&quot;</mark>라는
      						메시지가 VoiceOver에서 출력되는지 확인합니다.
      					</p>
      				</li>
      				<li>
      					<strong>진동 및 소리 테스트</strong>
      					<p>
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst info_lst gap-column-important-ms reference">
      				<li>
      					...
      					<p>
      						Android의 TalkBack 기능을 활성화하고, 알림 메시지가 음성으로 전달되는지 테스트합니다.<br />
      						예시) 오류 발생 시 TalkBack을 통해 <mark>&quot;네트워크 연결 오류가 발생했습니다.&quot;</mark>라는
      						메시지가 음성으로 출력되는지 확인합니다.
      					</p>
      				</li>
      				<li>
      					<strong>진동 테스트</strong>
      					<p>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml">
      				<strong className="font-16 weight-700 t_black">스크린 리더 사용</strong>
      				<p className="mt_sm">
      					NVDA 또는 JAWS와 같은 스크린 리더를 사용하여, 알림이 스크린 리더에서 제대로 인식되는지 확인합니다.<br />
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_l indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>알림 메시지 전송 및 스크린 리더 인식</span>
      						
      <CodeBlock title="알림 기능 - iOS 알림 메시지 전송" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="알림 기능 - iOS 진동 피드백 제공" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="알림 기능 - Android 알림 메시지 전송" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="알림 기능 - Android 진동 피드백 제공" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="알림 기능 - 00000000000" language="javascript" className="uk_gist_code_box">
      ...
      {`function App() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst info_lst gap-column-important-ms">
      				<li>
      					<strong>알림 메시지의 누락</strong>
      					<p>
      						중요한 상태 변화가 알림을 통해 전달되지 않는 경우.
      					</p>
      				</li>
      				<li>
      					<strong>스크린 리더와의 호환성 부족</strong>
      					<p>
      						알림 메시지가 스크린 리더에서 인식되지 않거나 누락되는 경우.
      					</p>
      				</li>
      				<li>
      					<strong>과도한 알림</strong>
      					<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-s">
      			<li>회원가입·결제·게시글 작성 등 핵심 시나리오 수행 중 인터럽션 노출 시점을 기록하고, 작업 실패·이탈이 발생하는지 확인합니다.</li>
      			<li>동일 인터럽션이 연속 노출되는지(재진입, 앱 재실행, 화면 복귀) 10회 이상 반복 테스트로 빈도 제한 정책을 검증합니다.</li>
      			<li>TalkBack/VoiceOver를 켠 상태에서 인터럽션 열기/닫기 후 초점 복귀 위치와 입력값 유지 여부를 점검합니다.</li>
      			<li>설정 화면에서 마케팅성 알림/팝업 비활성화 옵션이 제공되는지, 실제로 재노출이 차단되는지 확인합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/u7Acn6bv29A?si=age6LpHtmhsfbr0h" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">알림 기능 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
