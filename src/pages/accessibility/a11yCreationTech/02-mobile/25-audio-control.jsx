...
const PAGE_DATA = {
  title: "소리 자동 재생 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘소리 자동 재생’에 따라, 배경음·미디어 자동 재생을 제어 가능하게 하거나 사용자 동의 후에만 재생하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 자동 재생, 배경음, 소리 제어, 청각, 인식의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(명료성) : 자동 재생 소리를 제공하지 않거나 즉시 정지·일시정지·음량 조절할 수 있는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#audio-control" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Audio Control</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			보조 기술 음성과 자동 재생 콘텐츠가 동시에 출력되면 사용자는 둘 중 하나를 놓치게 됩니다.
      			특히 공공장소·조용한 환경에서는 음량 조절·음소거가 곧바로 가능해야 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>스크린 리더 사용자</strong><p>앱 음성이 읽기 음성을 가리는 사용자.</p></li>
      			<li><strong>청각 과민·편두통이 있는 사용자</strong><p>예고 없는 소리에 스트레스를 받는 사용자.</p></li>
      			<li><strong>보청기 사용자</strong><p>배경음과 음성이 겹치면 이해가 어려운 사용자.</p></li>
      			<li><strong>일반 사용자</strong><p>회의·수업·야간 모드에서 갑작스러운 소리를 피하려는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>3초 이상</strong><p>WCAG 관점에서 자동 재생이 3초를 넘기면 정지·음량 조절 UI가 바로 보이는가?</p></li>
      			<li><strong>루프 효과음</strong><p>짧은 효과음도 사용자 제어 없이 무한 반복되지 않는가?</p></li>
      			<li><strong>설정</strong><p>‘미디어 자동 재생’ 등 앱 설정에서 끌 수 있는가?</p></li>
      			<li><strong>동영상</strong><p>기본 음소거 후 사용자가 재생을 시작하는 패턴을 검토했는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>앱 최초 실행 시 ‘미디어 자동 재생 허용’ 여부를 묻고, 설정 화면에서 언제든 변경할 수 있게 합니다.</li>
      			<li>WebView·광고 SDK가 백그라운드에서 소리를 내지 않는지 네트워크 탭·실기기로 확인합니다.</li>
      			<li>iOS/Android 미디어 세션·Now Playing UI와 일시정지 동작을 연동합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>VoiceOver/TalkBack을 켠 상태로 홈 진입·딥링크 진입 시 자동 재생이 겹치는지 확인합니다.</li>
      			<li>무음 스위치·블루투스 연결/해제 등 오디오 라우트 변경 시에도 컨트롤이 유효한지 봅니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">소리 자동 재생 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
