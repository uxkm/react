...
const PAGE_DATA = {
  title: "부분 언어 표시 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘부분 언어 표시’에 따라, 한 화면 안에서 언어가 바뀌는 구간을 표기하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 부분 언어, mixed language, lang, 이해의 용이성",
}

function LanguageOfPartsPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(가독성) : 기본 언어와 구별되는 다른 언어는 해당 언어를 명시하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#language-of-parts" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Language of Parts</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>스크린 리더 사용자</strong><p>영문 약어와 한글 문장이 섞일 때 엔진을 바꿔 읽히길 원하는 사용자.</p></li>
      			<li><strong>이중 언어 교육·뉴스 앱 사용자</strong><p>인용문만 다른 언어로 표시되는 경우가 많은 사용자.</p></li>
      			<li><strong>RTL 혼합 UI</strong><p>아랍어·히브리어 구간이 끼어 있는 경우 방향 메타데이터가 필요한 사용자.</p></li>
      			<li><strong>콘텐츠 편집자</strong><p>CMS에서 블록 단위 언어를 지정할 수 있어야 합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>고유명사·브랜드</strong><p>외국어 고유명사에도 필요 시 <code>lang</code> 또는 발음 안내가 있는가?</p></li>
      			<li><strong>인용·법조문</strong><p>긴 외국어 인용이 한 덩어리로 올바른 언어 태그를 가지는가?</p></li>
      			<li><strong>네이티브 텍스트</strong><p>AttributedString/Spannable로 구간 로케일을 줄 수 있는가?</p></li>
      			<li><strong>번역 문자열</strong><p>플레이스홀더 안에 삽입되는 외국어 단어가 태그를 잃지 않는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>WebView 내부에서는 인라인 <code>lang</code>으로 구간을 감쌉니다.</li>
      			<li>네이티브 TextView에서도 스팬 단위 로케일 API를 활용할 수 있는지 확인합니다.</li>
      			<li>번역 가능 문자열과 고정 브랜드명을 구분해 관리합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스크린 리더로 혼합 문단을 읽으며 언어 전환 음성이 자연스러운지 확인합니다.</li>
      			<li>하이픈·줄바꿈이 언어별 규칙을 따르는지 짧은 샘플 문단으로 테스트합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">부분 언어 표시 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
...
export default LanguageOfPartsPage
