...
const PAGE_DATA = {
  title: "콘텐츠의 선형구조 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘콘텐츠의 선형구조’에 따라, 읽기 순서와 포커스 순서가 논리적으로 일치하도록 UI를 구성하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 선형구조, 포커스 순서, meaningful sequence, 인식의 용이성",
}

function LinearStructurePage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(적응성) : 콘텐츠의 읽기 순서와 포커스 이동 순서가 논리적으로 일치하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#meaningful-sequence" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Meaningful Sequence</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			순서가 뒤바뀌면 제목 다음에 본문이 오지 않거나, 확인 다이얼로그보다 배경이 먼저 읽히는 등 문맥이 깨집니다.
      			특히 동적 삽입·애니메이션·조건부 표시는 빌드 후 순서를 다시 점검해야 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>스크린 리더 사용자</strong><p>한 요소씩 순차 탐색하며 문서 흐름을 구성하는 사용자.</p></li>
      			<li><strong>키보드·스위치 접근 사용자</strong><p>포커스 이동만으로 전체 흐름을 따라가야 하는 사용자.</p></li>
      			<li><strong>인지 장애인</strong><p>예상 가능한 순서가 깨지면 작업을 중단하기 쉬운 사용자.</p></li>
      			<li><strong>고령 사용자</strong><p>복잡한 레이아웃에서 시선 이동과 음성 순서가 다를 때 혼란을 느끼는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>시각 vs 접근성 트리</strong><p>스크린샷 순서와 VoiceOver/TalkBack 탐색 순서를 비교했는가?</p></li>
      			<li><strong>동적 영역</strong><p>로딩 후 삽입된 뷰가 본문보다 앞서 읽히지 않는가?</p></li>
      			<li><strong>중첩 스크롤</strong><p>내부 리스트와 외부 스크롤 간 포커스 트랩이 없는가?</p></li>
      			<li><strong>모달·시트</strong><p>열릴 때 포커스가 본문으로 새지 않고 제목으로 이동하는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			...
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li><code>importantForAccessibility</code>로 장식용 뷰를 숨기거나, 읽기 순서 조정 API를 신중히 사용합니다.</li>
      				<li><code>RecyclerView</code> 아이템 재사용 시 포커스가 튀지 않도록 스테이트를 유지합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">iOS</h3>
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li>Auto Layout 제약 변경 후 VoiceOver로 전체 흐름을 다시 읽습니다.</li>
      				<li>커스텀 컨테이너는 자식 순서가 곧 읽기 순서임을 기억합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">WebView</h3>
      			<p className="mt_m">DOM 순서를 시각 순서와 맞추고, CSS <code>order</code>·그리드로만 순서를 뒤집지 않도록 합니다.</p>
      		</article>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스크린 리더 ‘다음 요소’만으로 주요 시나리오(가입, 결제)를 끝까지 수행해 봅니다.</li>
      			<li>가로·세로 전환, 글자 크기 최대, 다크 모드에서도 순서가 유지되는지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">콘텐츠의 선형구조 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default LinearStructurePage
