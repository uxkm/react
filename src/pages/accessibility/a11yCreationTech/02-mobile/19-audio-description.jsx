...
const PAGE_DATA = {
  title: "화면해설 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(인식의 용이성)의 ‘화면해설’에 따라, 대사·자막만으로는 전달되지 않는 시각 정보를 동등하게 제공하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 화면해설, 오디오 설명, 미디어 대체, 인식의 용이성, TalkBack, VoiceOver",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(멀티미디어 대체수단) : 음성 정보가 없는 시각 정보는 화면해설 또는 동등한 설명으로 인식 가능한가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#audio-description-prerecorded" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference — Audio Description (Prerecorded)</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			시각 장애인·저시력 사용자는 화면을 직접 보기 어렵고, 청각 장애인은 음성 정보만으로는 장면 맥락을 놓칠 수 있습니다.
      			화면해설(또는 동등한 텍스트·음성 설명)은 ‘무슨 일이 벌어지는지’를 시간축에 맞춰 전달해, 자막이 담지 못하는 공간 정보를 보완합니다.
      		</p>
      		<p className="mt_l">
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>시각 장애인·저시력 사용자</strong>
      				<p>화면을 읽기 어렵거나 세부 묘사를 놓치기 쉬운 사용자.</p>
      			</li>
      			<li>
      				<strong>청각 장애인</strong>
      				<p>효과음·배경음만으로 전달되는 정보가 있는 경우, 자막·원고와 함께 시각 맥락을 보완해야 하는 사용자.</p>
      			</li>
      			<li>
      				<strong>인지 장애·고령 사용자</strong>
      				<p>빠른 장면 전환만으로는 이해하기 어려워 요약 설명이 필요한 사용자.</p>
      			</li>
      			<li>
      				<strong>이동 중·저대역 환경 사용자</strong>
      				<p>영상 품질이 떨어져 시각 정보가 손실될 때 텍스트·음성 대체가 필요한 사용자.</p>
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>대사·자막에 없는 시각 정보 식별</strong>
      				<p>표정, 텍스트 오버레이, UI 조작, 지도·그래프 변화 등을 목록화했는가?</p>
      			</li>
      			<li>
      				<strong>동등한 설명 경로</strong>
      				<p>별도 오디오 트랙, 확장 오디오 설명, 인접 스크립트 패널, 장면별 텍스트 중 최소 한 가지로 제공하는가?</p>
      			</li>
      			<li>
      				<strong>재생 제어와 동기</strong>
      				<p>일시정지·탐색 시 설명이 영상과 어긋나지 않는가?</p>
      			</li>
      			<li>
      				<strong>보조 기술 시나리오</strong>
      				<p>스크린 리더로 플레이어에 진입했을 때 설명 텍스트·역할이 노출되는가?</p>
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			...
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li><code>AVPlayer</code> 외부 트랙, 사용자 설정에 따른 오디오 설명 켜기/끄기 등을 제공합니다.</li>
      				<li>커스텀 플레이어는 VoiceOver 포커스 순서·슬라이더 역할·시간 레이블을 점검합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">Android</h3>
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li>ExoPlayer 등에서 보조 오디오 트랙 또는 자막 트랙에 장면 설명을 넣을 수 있는지 검토합니다.</li>
      				<li>전체 화면 시 시스템 뒤로가기·탐색바와 포커스가 충돌하지 않는지 확인합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">하이브리드(WebView)</h3>
      			<p className="mt_m">
      				HTML5 <code>&lt;track kind="descriptions"&gt;</code> 또는 별도 텍스트 패널과 동기화된 ARIA live 영역 등, 웹 표준에 맞는 대안을 우선 적용합니다.
      			</p>
      		</article>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>시각 정보 목록과 실제 음성/텍스트 설명을 대조하여 누락 항목이 없는지 검토합니다.</li>
      			<li>무음 구간·효과음만 있는 구간을 골라, 설명 없이도 이해 가능한지 스크린 리더로 확인합니다.</li>
      			<li>‘설명 끄기’ 옵션이 있을 때 기본 자막·대사만으로 동등한 이해가 가능한지 재확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">화면해설 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
