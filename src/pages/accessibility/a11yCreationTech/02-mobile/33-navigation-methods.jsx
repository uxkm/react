...
const PAGE_DATA = {
  title: "다양한 탐색 방법 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘다양한 탐색 방법’에 따라, 메뉴·검색·바로가기 등 서로 다른 경로로 목표에 도달하게 하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 탐색, 검색, 메뉴, 내비게이션, 운용의 용이성",
}

function NavigationMethodsPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(쉬운 내비게이션) : 메뉴·검색·내비게이션 등 두 가지 이상의 탐색 수단을 제공하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#multiple-ways" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Multiple Ways</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>기억·인지 부담이 큰 사용자</strong><p>계층 메뉴 위치를 외우기 어려워 검색·즐겨찾기를 선호하는 사용자.</p></li>
      			<li><strong>운동 장애인</strong><p>긴 스크롤보다 바로가기 타일이 편한 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>헤딩·랜드마크·검색으로 같은 화면에 도달할 수 있어야 하는 사용자.</p></li>
      			<li><strong>파워 사용자</strong><p>딥링크·위젯·단축 Siri/Android 단축어로 반복 작업을 줄이려는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>두 경로 이상</strong><p>핵심 기능(설정, 고객센터, 결제 내역 등)에 서로 다른 진입 경로가 있는가?</p></li>
      			<li><strong>검색 범위</strong><p>전역 검색이 화면별 필터와 역할이 겹치지 않고 보완하는가?</p></li>
      			<li><strong>구조 탐색</strong><p>헤딩·탭·랜드마크만으로도 주요 구역에 도달하는가?</p></li>
      			<li><strong>딥링크</strong><p>URL 스킴·App Links로 특정 화면을 직접 열 수 있는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>글로벌 검색과 화면별 필터가 역할이 겹치지 않도록 명확히 나눕니다.</li>
      			<li>스크린 리더에서 랜드마크·헤딩 순탐으로도 주요 구역에 도달할 수 있는지 확인합니다.</li>
      			<li>딥링크 URL 스킴으로 특정 화면을 직접 열 수 있으면 탐색 보조가 됩니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>동일 목표 화면까지 메뉴 경로와 검색 경로를 각각 시간을 재며 비교합니다.</li>
      			<li>스크린 리더만 켜고 헤딩/컨테이너 탐색으로 도달 가능한지 체크리스트를 만듭니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">다양한 탐색 방법 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default NavigationMethodsPage
