...
const PAGE_DATA = {
  title: "동작기반 작동 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘동작기반 작동’에 따라, 흔들기·기울이기만으로 실행되는 기능에 UI 대체와 끄기 옵션을 두는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 동작기반, motion, 흔들어 실행, 기울기, 운용의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 방식) : 흔들기·기울이기 등 동작기반 기능을 UI로 대체하거나 비활성화할 수 있는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#motion-actuation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Motion Actuation</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>휠체어·거치대 사용자</strong><p>기기 방향을 자유롭게 바꾸기 어려운 사용자.</p></li>
      			<li><strong>파킨슨 등 떨림이 있는 사용자</strong><p>의도치 않은 흔들기 입력이 들어가기 쉬운 사용자.</p></li>
      			<li><strong>전신 마비·한 손 사용</strong><p>기울이기 제스처로는 정밀한 각도 조절이 어려운 사용자.</p></li>
      			<li><strong>OS 접근성 설정 사용자</strong><p>‘동작 줄이기’를 켠 환경에서도 기능을 쓰려는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>대체 UI</strong><p>동작으로만 가능했던 기능을 버튼으로도 수행할 수 있는가?</p></li>
      			<li><strong>끄기</strong><p>앱 설정에서 동작 단축을 비활성화할 수 있는가?</p></li>
      			<li><strong>실수 방지</strong><p>흔들어 취소·흔들어 실행이 중요하지 않은 곳에만 쓰이는가?</p></li>
      			<li><strong>센서 필수 기능</strong><p>AR·운동 측정 등 본질적으로 동작이 필요한 경우 예외와 안내가 문서화되었는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>‘흔들어 실행’류 기능은 최초 실행 시 안내하고, 설정 &gt; 접근성에서 끌 수 있게 합니다.</li>
      			<li>AR·게임 등 센서가 필수인 경우에도 UI 대체 경로를 제공할 수 있는지 검토합니다.</li>
      			<li>OS의 ‘동작 줄이기’ 설정과 충돌하지 않는지 확인합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>기기를 테이블에 고정한 채 전체 사용자 시나리오를 수행해 봅니다.</li>
      			<li>iOS ‘동작 줄이기’, Android에서 해당 옵션을 켠 뒤 동작 단축이 비활성화되는지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">동작기반 작동 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
