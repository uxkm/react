...
const PAGE_DATA = {
  title: "오류 방지 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘오류 방지’에 따라, 법적·금전적·데이터에 영향을 주는 제출 전 확인·취소 수단을 두는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 오류 방지, 확인, 되돌리기, 결제, 이해의 용이성",
}

function ErrorPreventionPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 도움) : 중요한 정보가 제출되기 전 되돌리기 어려운 오류를 방지할 수 있는 수단을 제공하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#error-prevention-legal-financial-data" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Error Prevention (Legal, Financial, Data)</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>인지 부담이 큰 사용자</strong><p>숫자와 수신인을 바꿔 치기 쉬운 사용자.</p></li>
      			<li><strong>운동 장애인</strong><p>잘못된 버튼을 눌렀을 때 되돌리기 어려운 사용자.</p></li>
      			<li><strong>고령 사용자</strong><p>요약 없이 바로 전송되면 불안을 느끼는 사용자.</p></li>
      			<li><strong>기업·공공 서비스</strong><p>감사 추적을 위해 확인 단계 로그가 필요한 경우가 많습니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>검토 화면</strong><p>최종 제출 전 핵심 값이 한눈에 보이는가?</p></li>
      			<li><strong>되돌리기</strong><p>일정 시간 내 취소·환불 요청이 가능한가?</p></li>
      			<li><strong>재입력</strong><p>계좌번호 등은 두 번 입력하게 하거나 붙여넣기 검증이 있는가?</p></li>
      			<li><strong>자동 완성</strong><p>자동 채움으로 바뀐 값이 눈에 띄게 표시되는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>금액·수신인 등 핵심 값은 입력 단계와 확인 단계에서 동시에 보여 줍니다.</li>
      			<li>자동 완성으로 바뀐 값은 사용자가 눈으로 검토할 수 있게 합니다.</li>
      			<li>‘실수로 눌렀을 때’를 가정한 취소 경로를 설계합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>결제·가입 해지·데이터 삭제 플로우에 QA 시나리오를 별도 문서로 두고 단계별 스크린샷을 남깁니다.</li>
      			<li>스크린 리더로 확인 화면을 읽었을 때 모든 핵심 값이 읽히는지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">오류 방지 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
...
export default ErrorPreventionPage
