...
const PAGE_DATA = {
  title: "접근 가능한 인증 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘접근 가능한 인증’에 따라, 퍼즐·기억 테스트만으로 로그인을 막지 않는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 인증, CAPTCHA, WebAuthn, 패스키, 이해의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 도움) : 인증 과정은 인지 기능 테스트에만 의존하지 않는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#accessible-authentication" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Accessible Authentication</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>인지 장애인</strong><p>퍼즐·패턴 암기에 어려움을 겪는 사용자.</p></li>
      			<li><strong>저시력·색약 사용자</strong><p>이미지 CAPTCHA를 구분하기 어려운 사용자.</p></li>
      			<li><strong>운동 장애인</strong><p>슬라이더·드래그형 인증을 정확히 수행하기 힘든 사용자.</p></li>
      			<li><strong>전체 사용자</strong><p>모바일 키보드에서 긴 무작위 비밀번호 입력을 피하려는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>대체 경로</strong><p>CAPTCHA·퍼즐 외에 이메일 링크·SMS·기기 인증 등이 있는가?</p></li>
      			<li><strong>패스키·생체</strong><p>지원 기기에서 비밀번호 없이도 로그인할 수 있는가?</p></li>
      			<li><strong>오류 복구</strong><p>실패 시 과도한 대기·차단 없이 다른 수단을 시도할 수 있는가?</p></li>
      			<li><strong>보조 기술</strong><p>인증 UI가 스크린 리더·키보드만으로 완료 가능한가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>CAPTCHA는 음성 대체·관리자 확인 등 동등한 우회 경로를 제공합니다.</li>
      			<li>WebAuthn·FIDO2 등 표준을 활용해 비밀번호 의존도를 낮춥니다.</li>
      			<li>실패 시 다음 시도까지 불필요하게 긴 대기를 두지 않습니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스크린 리더만으로 로그인·2단계 인증을 끝까지 수행해 봅니다.</li>
      			<li>CAPTCHA가 있는 경우 대체 경로가 실제로 노출·동작하는지 운영 환경에서 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">접근 가능한 인증 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
