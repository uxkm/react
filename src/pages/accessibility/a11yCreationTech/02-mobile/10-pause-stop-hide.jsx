...
const PAGE_DATA = {
  title: "움직임 제어 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '움직임 제어'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 정지 기능 제공, 자동 변경, 정지 버튼, 사용자 제어, 시각적 장애 사용자, 인지 장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(충분한 시간 제공) : 자동으로 변경되는 콘텐츠는 움직임을 제어할 수 있어야 한다.</b><br />
      			정지 기능을 제공함으로써 사용자는 자동 변경 콘텐츠를 효과적으로 제어할 수 있으며,
      			특히 접근성 요구가 있는 사용자에게 중요한 편의를 제공합니다.
      			모든 사용자에게 안정적이고 예측 가능한 사용자 경험을 제공할 수 있도록 정지 기능을 필수적으로 제공해야 합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#pause-stop-hide" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Pause, Stop, Hide</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			자동으로 변경되는 콘텐츠는 사용자가 주의 집중을 방해하거나 중요한 정보를 놓치게 할 수 있습니다.
      			특히, 시각적 피로 또는 광민감성 발작이 있는 사용자는 움직임이 많은 콘텐츠로 인해 불편을 느낄 수 있습니다.
      			따라서 콘텐츠의 자동 변환 기능을 제어하는 옵션은 모든 사용자에게 필수적입니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>정지 기능 제공 여부</strong>
      				<p>
      					모든 자동 변경 콘텐츠가 정지 가능한지 여부를 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>컨트롤 접근성</strong>
      				<p>
      ...
      <CodeBlock title="정지 기능 제공 - iOS 정지/재생 버튼" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      ...
      <CodeBlock title="정지 기능 제공 - Android 정지/재생 버튼" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="정지 기능 제공 - html 자동 슬라이드 제어" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="정지 기능 제공 - Vue 슬라이드 전환, 정지 버튼" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      								<div></div>
      								<button @click="toggleSlideshow"></button>
      							</div>
      						</template>
      ...
      <CodeBlock title="정지 기능 제공 - React 슬라이드 제어" language="javascript" className="uk_gist_code_box">
      {`import React, { useState, useEffect } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/z5nhDxrSblM?si=O2gdkjdf9JMwycqn" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (10. 정지 기능 제공)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">움직임 제어 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
