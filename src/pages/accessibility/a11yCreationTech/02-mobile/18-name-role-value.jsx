...
const PAGE_DATA = {
  title: "사용자 인터페이스 컴포넌트 | 모바일 접근성 콘텐츠 제작 기법(\"견고성(Robust)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(견고성)의 '사용자 인터페이스 컴포넌트' 항목에 해당하는 이름·역할·값 노출과 보조 기술 호환을 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 보조 기술과의 호환성, 스크린 리더, 음성 명령, 스위치 제어, 사용자 인터페이스(UI) 호환성, 시각 장애인, 청각 장애인, 인지 장애인, 신체 장애인, Android, iOS",
}

function NameRoleValuePage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(보조기술과의 호환성) : 사용자 인터페이스 컴포넌트가 보조기술에서 조작·인지 가능하도록 이름(네임)·역할·값이 적절히 노출되는가?</b><br />
      			보조 기술과의 호환성은 모든 사용자 인터페이스 컴포넌트가 TalkBack,
      			VoiceOver 등 보조 기술과 원활하게 상호작용할 수 있도록 설계해야 한다는 의미입니다.
      			사용자에게 필수적인 정보를 제공하고,
      			앱을 탐색하고 기능을 사용할 때 필요한 각종 버튼, 링크, 입력 필드 등이 보조 기술을 통해 접근 가능해야 합니다.
      			모든 UI 요소에 적절한 접근성 속성을 추가하여, 사용자에게 시각적·청각적 피드백이 아닌 정보도 전달될 수 있도록 합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="/accessibility/a11y/04-a11yCag/03-macag" className="fas weight-500">모바일 앱 접근성 체크리스트(MACAG) — 견고성</a><br />
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#compatible-with-assistive-technologies" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Compatible with Assistive Technologies</a>
      		</p>
      	</blockquote>

      	<section className="indent mt_xxl">
      		<h2 className="ml_mn" data-conlist="false">보조 기술과의 호환성 예시</h2>
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				<strong>TalkBack</strong>
      				<p>
      					TalkBack 사용자도 버튼에 &quot;뒤로 가기&quot;라는 라벨이 읽히도록 설정.
      				</p>
      			</li>
      			<li>
      				<strong>스위치 제어</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			시각장애인 등의 사용자는 모바일 기기에서 제공하는 장애인 보조 기술을 사용하여 애플리케이션을 이용하게 됩니다.
      			만약 애플리케이션의 사용자 인터페이스 컴포넌트가 보조 기술의 사용을 지원하지 않는다면
      			보조 기술을 사용하는 장애인은 애플리케이션을 이용할 수 없는 상황에 처하게 됩니다.
      		</p>
      		<p className="mt_ms">
      			애플리케이션에서 보조 기술을 지원하는 가장 효과적인 방법은 기본사용자인터페이스 컴포넌트를
      			사용하는 것이나 부득이 사용자정의 컴포넌트를 사용할 경우 보조 기술로도 접근할 수 있는 속성들을 반드시 제공해야 합니다.
      		</p>
      		<p className="mt_ms">
      			기본적으로는 사용자 인터페이스 컴포넌트가 어떤 유형(버튼, 슬라이더 등)인지 정보를 제공해야 합니다.
      			시각장애인의 경우 디자인을 인지할 수 없으므로 컴포넌트의 종류에 따라 조작하는 방법을 선택하게 되므로
      			사용자 인터페이스 컴포넌트의 유형을 명확히 제공하는 것이 중요합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">Vue.js</h3>
      			<div className="mt_ml">
      				<strong className="el_block mb_sm font-16 weight-700 t_black">스크린 리더 테스트</strong>
      				<p>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml">
      				<strong className="el_block mb_sm font-16 weight-700 t_black">스크린 리더 및 자동화 도구</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>보조 기술 호환성 점수</strong>
      				<p>
      					보조 기술 사용자 테스트를 통해 모든 UI 컴포넌트가 호환성 요구사항을 충족하는지 평가.
      				</p>
      			</li>
      			<li>
      				<strong>스위치 제어 탐색 가능성</strong>
      				<p>
      					모든 UI 요소가 스위치 제어로 탐색 및 조작 가능한지 여부.
      				</p>
      			</li>
      			<li>
      				<strong>TalkBack 및 VoiceOver 적합성</strong>
      				<p>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_l indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>VoiceOver용 접근성 라벨 설정</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [iOS] VoiceOver용 접근성 라벨 설정" language="javascript" className="uk_gist_code_box">
      {`let backButton = UIButton()
      					...
      					<li>
      						<span>상태 변경을 인식하도록 알림</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [iOS] 상태 변경을 인식하도록 알림" language="javascript" className="uk_gist_code_box">
      {`UIAccessibility.post(notification: .announcement, argument: "네트워크 연결이 성공했습니다.")`}
      </CodeBlock>

      					</li>
      					<li>
      						<span>키보드 및 스위치 제어 탐색 설정</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [iOS] 키보드 및 스위치 제어 탐색 설정" language="javascript" className="uk_gist_code_box">
      {`myButton.isAccessibilityElement = true
      			...
      			<div className="mt_l indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>TalkBack용 접근성 라벨 설정</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [Android] TalkBack용 접근성 라벨 설정" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="보조 기술과의 호환성 - [Android] 상태 변경을 인식하도록 알림" language="javascript" className="uk_gist_code_box">
      {`AccessibilityEvent event = AccessibilityEvent.obtain(AccessibilityEvent.TYPE_ANNOUNCEMENT);
      					...
      					<li>
      						<span>스위치 제어 탐색 설정</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [Android] 스위치 제어 탐색 설정" language="javascript" className="uk_gist_code_box">
      {`myButton.setFocusable(true);
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>ARIA 라벨과 역할(role) 설정</span>
      						
      <CodeBlock title="보조 기술과의 호환성 - [html] ARIA 라벨과 역할(role) 설정" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="보조 기술과의 호환성 - [html] 상태 변경을 인식하도록 알림" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="보조 기술과의 호환성 - [Vue] 접근성 라벨과 역할 설정" language="javascript" className="uk_gist_code_box">
      {`<template>
      ...
      <CodeBlock title="보조 기술과의 호환성 - [React] 접근성 라벨과 역할 설정" language="javascript" className="uk_gist_code_box">
      {`function App() {
      							return (
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst info_lst gap-column-important-ms">
      				<li>
      					<strong>TalkBack 및 VoiceOver 호환성 부족</strong>
      					<p>
      						버튼이나 링크가 TalkBack 및 VoiceOver에서 인식되지 않는 경우.
      					</p>
      				</li>
      				<li>
      					<strong>스위치 제어 비호환</strong>
      					<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/FTJCDVhGmVE?si=FEXhxel7qtI_6Yas" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (18. 보조기술과의 호환성)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">사용자 인터페이스 컴포넌트 | 모바일 접근성 콘텐츠 제작 기법(&quot;견고성(Robust)&quot;) 참조</strong>
...
export default NameRoleValuePage
