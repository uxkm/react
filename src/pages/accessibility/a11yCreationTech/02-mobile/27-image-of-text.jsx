...
const PAGE_DATA = {
  title: "이미지 텍스트 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘이미지 텍스트’에 따라, 필수 정보를 비트맵으로만 두지 않고 실제 텍스트로 제공하거나 동등한 대체를 두는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 이미지 텍스트, image of text, 확대, 대체 텍스트, 인식의 용이성",
}

function ImageOfTextPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(명료성) : 필수 정보 텍스트를 이미지로만 제공하지 않으며, 예외 시 동등한 텍스트를 함께 제공하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#images-of-text" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Images of Text</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			이미지 속 텍스트는 OS 글자 크기 설정을 따르지 않고, 스크린 리더가 내용을 정확히 읽기 어렵습니다.
      			실제 텍스트 뷰와 스타일을 사용하면 동일한 디자인을 유지하면서도 접근성 요구를 만족시키기 쉽습니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>저시력·고령 사용자</strong><p>동적 타입·확대에 맞춰 글자가 커져야 읽을 수 있는 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>OCR에 의존하지 않고 문장 단위로 읽히길 원하는 사용자.</p></li>
      			<li><strong>번역·검색이 필요한 사용자</strong><p>텍스트를 복사하거나 기기 번역을 적용하려는 사용자.</p></li>
      			<li><strong>디자이너·마케터</strong><p>브랜드 타이포를 유지하면서도 텍스트 레이어로 구현할 수 있는지 협업이 필요합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>본문·가격·약관</strong><p>업무에 필요한 문자열이 모두 텍스트 뷰인가?</p></li>
      			<li><strong>예외</strong><p>로고·필수 브랜딩 이미지는 대체 텍스트 또는 근처 실제 텍스트로 동등 정보가 있는가?</p></li>
      			<li><strong>아이콘 폰트·SVG</strong><p>보조 기술 이름과 사용자가 인지하는 시각 텍스트가 일치하는가?</p></li>
      			<li><strong>캐러셀 배너</strong><p>이미지 안 문구가 아닌, 접근 가능한 제목·설명이 별도로 있는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>광고 배너 등 이미지가 불가피할 때는 <code>accessibilityLabel</code>·숨김 텍스트로 동등한 문구를 제공합니다.</li>
      			<li>SVG·아이콘 폰트 사용 시에도 보조 기술에 읽힐 이름과 텍스트 복제 가능 여부를 확인합니다.</li>
      			<li>브랜드 서체가 필요하면 스타일된 Text 컴포넌트와 대체 스타일을 함께 준비합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>OS 글자 크기를 최대로 올렸을 때 이미지 텍스트만 깨지거나 잘리는 구간이 없는지 확인합니다.</li>
      			<li>스크린 리더로 읽었을 때 이미지와 실제 텍스트의 내용이 동일한지 비교합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">이미지 텍스트 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default ImageOfTextPage
