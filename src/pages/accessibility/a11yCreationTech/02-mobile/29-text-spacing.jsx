...
const PAGE_DATA = {
  title: "텍스트 간격 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘텍스트 간격’에 따라, 줄·자간·단락 간격이 넓어져도 UI가 깨지지 않게 하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 텍스트 간격, letter spacing, line height, 가독성, 인식의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(명료성) : 줄·단락·자간·단어 간격 조정 시에도 콘텐츠와 기능이 유지되는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#text-spacing" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Text Spacing</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			난독·저시력 사용자는 행간·자간을 넓혀 읽는 경우가 많습니다.
      			고정 높이의 라벨이나 한 줄 클립 처리는 간격이 조금만 변해도 내용이 잘립니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>난독·학습 장애인</strong><p>글자 간격을 넓혀야 단어 경계를 안정적으로 읽는 사용자.</p></li>
      			<li><strong>저시력 사용자</strong><p>행간을 키워 줄 사이를 구분하려는 사용자.</p></li>
      			<li><strong>고령 사용자</strong><p>작은 라벨이 두 줄로 넘어가도 버튼과 겹치지 않길 원하는 사용자.</p></li>
      			<li><strong>WebView 콘텐츠 편집자</strong><p>사용자 스타일시트·리더 뷰와 충돌하지 않는 마크업이 필요합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>WCAG 텍스트 간격 세트</strong><p>line-height 1.5, paragraph margin 2em 등 권장 값을 적용해 깨짐이 없는가?</p></li>
      			<li><strong>한 줄 클립</strong><p>타이틀·버튼 라벨이 멀티라인으로 흐를 수 있는가?</p></li>
      			<li><strong>아이콘+텍스트</strong><p>줄바꿈 시에도 아이콘 의미와 터치 타깃이 유지되는가?</p></li>
      			<li><strong>입력 필드</strong><p>플로팅 레이블이 확대·간격 조정 시 필드와 겹치지 않는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>멀티라인 텍스트에는 최소 높이 고정 대신 intrinsic 콘텐츠 크기에 맞는 제약을 사용합니다.</li>
      			<li>WebView에서는 CSS <code>line-height</code>, <code>letter-spacing</code> 사용자 스타일이 깨지지 않는지 확인합니다.</li>
      			<li>아이콘과 텍스트를 한 줄에 억지로 맞추지 말고, 줄바꿈 시에도 아이콘 의미가 유지되게 배치합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>접근성 단축키·개발자 도구로 WCAG 텍스트 간격 값을 일괄 적용한 뒤 주요 화면을 스크린샷 비교합니다.</li>
      			<li>iOS 동적 타입·Android 글꼴 크기 최대에서 동일 시나리오를 반복합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">텍스트 간격 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default TextSpacingPage
