...
const PAGE_DATA = {
  title: "방향 설정 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘방향 설정’에 따라, 특정 화면 방향에만 고정하지 않고 가로·세로에서 동등하게 이용할 수 있게 하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, orientation, 가로, 세로, 화면 회전, 인식의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(적응성) : 콘텐츠를 특정 화면 방향으로만 고정하지 않고 가로/세로 모두에서 이용 가능한가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#orientation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Orientation</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			강제 세로·가로는 물리적 제약뿐 아니라 태블릿·폴더블·외부 디스플레이 등 다양한 폼 팩터에서도 문제가 됩니다.
      			핵심 기능이 한 방향에서만 가능하면 사용자는 앱을 포기할 수 있습니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>거치대·휠체어 사용자</strong><p>기기를 회전하기 어려운 각도로 고정하는 사용자.</p></li>
      			<li><strong>한 손 사용</strong><p>세로 고정이 편한 경우에도 가로 콘텐츠를 봐야 할 때가 있는 사용자.</p></li>
      			<li><strong>태블릿·멀티윈도우</strong><p>가로 폭이 줄어든 상태에서도 레이아웃이 깨지지 않아야 하는 사용자.</p></li>
      			<li><strong>개발자·QA</strong><p>회전 각도·크기 클래스별 회귀 테스트가 필요합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>양방향 레이아웃</strong><p>주요 화면이 가로·세로 모두에서 스크롤·버튼·입력이 가능한가?</p></li>
      			<li><strong>예외 정당성</strong><p>한 방향 고정이 법·규격·본질적 특성(예: 카메라 뷰파인더) 때문인지 문서화했는가?</p></li>
      			<li><strong>전환 시 상태</strong><p>회전 후 입력값·스크롤 위치·포커스가 유지되는가?</p></li>
      			<li><strong>전체 화면 모드</strong><p>비디오·게임 전용 모드에서도 나가기·설정 경로가 있는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>Android: <code>screenOrientation</code> 값을 가능한 한 제한하지 않고, 필요 시 사용자에게 이유를 안내합니다.</li>
      			<li>iOS: 지원 방향과 Info.plist 설정, Adaptive Layout 제약을 양방향에서 검증합니다.</li>
      			<li>WebView는 viewport·safe area를 회전별로 테스트합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>실기기에서 회전 잠금 on/off 각각으로 주요 시나리오를 수행합니다.</li>
      			<li>분할 화면·멀티태스킹으로 앱 가로폭이 줄었을 때를 시뮬레이션합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">방향 설정 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
