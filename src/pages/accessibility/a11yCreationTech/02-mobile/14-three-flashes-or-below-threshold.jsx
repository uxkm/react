...
const PAGE_DATA = {
  title: "깜빡임과 번쩍임 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '깜빡임과 번쩍임'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 깜빡거림의 사용 제한, 깜빡임, 번쩍임, 광민감성 발작, 시각적 자극, 발작 예방, 고령 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(광과민성 발작 예방) : 깜빡이거나 번쩍이는 콘텐츠를 제공하지 않아야 한다.</b><br />
      			모바일 앱과 웹 애플리케이션에서 깜박이거나 번쩍이는 콘텐츠를 제한하는 것은 매우 중요한 접근성 원칙입니다.
      			특정 시각적 효과는 사용자의 건강에 영향을 미칠 수 있으며,
      			특히 발작이나 광민감성 발작을 유발할 수 있는 사용자가 위험에 처할 수 있습니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#three-flashes-or-below-threshold" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Three Flashes or Below Threshold</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l">
      			깜박이거나 번쩍이는 콘텐츠는 특정 사용자 그룹에게 심각한 건강 문제를 일으킬 수 있습니다.
      			특히 광민감성 발작이 있는 사용자에게는 3Hz에서 60Hz 사이의 깜박임이 발작을 유발할 수 있습니다.
      			따라서 콘텐츠의 깜박임을 제한하거나 제거하는 것은 이러한 위험을 줄이는 데 필수적입니다.
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>광민감성 발작 위험이 있는 사용자</strong>
      				<p>
      					특정 빈도의 깜박임에 민감한 사용자.
      				</p>
      			</li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>깜박임 빈도 제한</strong>
      				<p>
      					콘텐츠의 깜박임 빈도가 초당 3회 미만이거나 60회 초과인지를 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>자동 재생 제한</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">CSS 애니메이션 제한</h3>
      			<p className="mt_ms">
      				CSS 애니메이션 사용 시 깜박임 효과를 제한합니다.
      			</p>
      			
      <CodeBlock title="깜박거림의 사용 제한 - CSS 애니메이션 제한" language="javascript" className="uk_gist_code_box">
      {`.no-blink-animation {
      						animation: none;
      					}`}
      </CodeBlock>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">JavaScript 애니메이션 제어</h3>
      			<p className="mt_ms">
      				깜박임을 유발할 수 있는 JavaScript 애니메이션은 주의하여 사용합니다.
      			</p>
      			
      <CodeBlock title="깜박거림의 사용 제한 - JavaScript 애니메이션 제어" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="깜박거림의 사용 제한 - 애니메이션 사용자 제어" language="javascript" className="uk_gist_code_box">
      {`<template>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>깜박임 및 발작 예방 기준 준수 여부</strong>
      				<p>
      					콘텐츠가 초당 3회에서 60회 사이의 빈도로 깜박이지 않는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>사용자 제어 기능 존재 여부</strong>
      				<p>
      					번쩍임이 있을 경우 사용자가 이를 중지할 수 있는 옵션이 있는지 점검합니다.
      				</p>
      			</li>
      			<li>
      				<strong>디자인 가이드라인 준수</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/jyfP6mqbu2o?si=JxgBBRRJ7vwJ8H5E" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (14. 깜빡거림의 사용 제한)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">깜빡임과 번쩍임 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
