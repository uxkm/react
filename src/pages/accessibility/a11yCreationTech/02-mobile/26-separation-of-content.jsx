...
const PAGE_LAYOUT = {
  mainClass: "separation-of-content",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "콘텐츠 간의 구분 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘콘텐츠 간의 구분’에 따라, 인접 영역을 시각·구조적으로 구별하고 보조 기술에서도 그룹 관계를 전달하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 콘텐츠 구분, 레이아웃, 여백, 그룹, 인식의 용이성",
}

function SeparationOfContentPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(명료성) : 이웃한 콘텐츠 영역이 경계·여백·대비 등으로 시각적으로 구별되는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#non-text-contrast" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Non-text Contrast</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			구획이 분명하면 사용자는 관련 정보를 묶어 이해하고, 다음 조작 대상을 빠르게 찾을 수 있습니다.
      			명도 대비와 별개로, 영역 간 여백과 구분선은 인지 부하를 줄이는 데 도움이 됩니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>저시력 사용자</strong><p>배경과 카드 경계가 흐릿하면 스크롤 방향과 클릭 대상을 헷갈리는 사용자.</p></li>
      			<li><strong>인지 장애인</strong><p>정보 덩어리 경계가 불명확하면 흐름을 놓치기 쉬운 사용자.</p></li>
      			<li><strong>터치 조작 사용자</strong><p>인접 버튼을 잘못 누르는(미스탭) 빈도를 줄이려는 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>시각적 그룹이 헤딩·리스트·컨테이너 역할로도 전달되어야 하는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>시각적 단서</strong><p>여백, 구분선, 배경 톤, 그림자 중 둘 이상으로 블록이 구분되는가?</p></li>
      			<li><strong>UI 경계 대비</strong><p>입력 필드 테두리·포커스 링·구분선이 배경과 충분히 대비되는가?</p></li>
      			<li><strong>다크 모드</strong><p>고대비·다크 테마에서도 경계가 사라지지 않는가?</p></li>
      			<li><strong>의미 구조</strong><p>같은 그룹이 스크린 리더에서 연속 읽기·헤딩 탐색으로 묶이는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>그룹 제목·구분선·배경 톤 차이 등 둘 이상의 시각적 단서를 조합합니다.</li>
      			<li>스크린 리더에서는 <code>heading</code>·리스트·컨테이너 역할(<code>CollectionView</code> 등)으로 동일한 그룹 관계를 음성으로도 전달합니다.</li>
      			<li>플로팅 요소가 본문 블록과 겹치지 않도록 safe area·z-order를 조정합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>화면 캡처를 흑백·저해상도로 줄여 경계가 남는지 확인합니다.</li>
      			<li>헤딩 로터/목록 탐색만으로 주요 섹션 경계가 음성으로도 느껴지는지 점검합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">콘텐츠 간의 구분 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default SeparationOfContentPage
