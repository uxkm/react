...
const PAGE_DATA = {
  title: "표의 구성 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG 인식의 용이성 ‘표의 구성’에 맞춰, 헤더·셀 관계가 보조 기술로 전달되도록 표를 설계하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 표, 테이블, 헤더, AccessibilityNodeInfo, 인식의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(적응성) : 표의 제목, 열/행 제목, 헤더-데이터 관계가 이해 가능하도록 구성했는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#info-and-relationships" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference — Info and Relationships</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			모바일 화면은 열 수가 적고 가로 스크롤이 생기기 쉬워, 동일한 표라도 웹보다 맥락이 잘릴 수 있습니다.
      			행/열 헤더, 캡션, 고정 헤더(스티키) 여부가 보조 기술에 어떻게 전달되는지가 핵심입니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>시각 장애인</strong><p>셀 단위 탐색에 헤더 이름을 음성으로 듣고 데이터를 해석하는 사용자.</p></li>
      			<li><strong>저시력·확대 사용자</strong><p>열이 잘려 헤더와 본문이 떨어져 보일 때 관계를 잃지 않아야 하는 사용자.</p></li>
      			<li><strong>인지 장애인</strong><p>복잡한 표를 단계적으로 이해하려는 사용자.</p></li>
      			<li><strong>일반 사용자</strong><p>정렬·필터 후에도 헤더가 유지되는지 모두에게 유리합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>표 제목·요약</strong><p>표 전체를 설명하는 캡션 또는 접근 가능한 이름이 있는가?</p></li>
      			<li><strong>헤더 셀</strong><p>첫 행/열(또는 복합 헤더)이 데이터 셀과 논리적으로 연결되는가?</p></li>
      			<li><strong>병합 셀</strong><p><code>rowspan</code>/<code>colspan</code> 사용 시 읽기 순서가 끊기지 않는가?</p></li>
      			<li><strong>가로 스크롤</strong><p>스크롤 후에도 어떤 열 헤더가 적용되는지 사용자에게 남는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_l indent">
      			...
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li><code>RecyclerView</code> 그리드에서 행·열 헤더를 별도 뷰로 두고, 데이터 셀에 <code>CollectionItemInfo</code> 등으로 관계를 노출합니다.</li>
      				<li>중첩 스크롤 시 접근성 포커스가 헤더 밖으로 나가지 않도록 테스트합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">iOS</h3>
      			<ul className="mt_m dot_lst gap-column-important-sm">
      				<li>커스텀 표는 <code>UIAccessibilityContainer</code> 또는 표준 컨트롤 조합으로 헤더-셀 관계를 모사합니다.</li>
      				<li>가로 모드 전환 시 열 너비·헤더 고정 정책을 재검증합니다.</li>
      			</ul>
      		</article>
      		<article className="mt_l indent">
      			<h3 className="ml_mn t_blue">하이브리드</h3>
      			<p className="mt_m"><code>th</code>, <code>scope</code>, <code>headers</code>/<code>id</code> 연결, <code>caption</code> 등 HTML 표준을 우선합니다.</p>
      		</article>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>TalkBack/VoiceOver로 셀 이동 시 헤더 이름이 선행 음성에 포함되는지 확인합니다.</li>
      			<li>Accessibility Scanner·Layout Inspector로 노출 속성을 교차 검증합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">표의 구성 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default TableStructurePage
