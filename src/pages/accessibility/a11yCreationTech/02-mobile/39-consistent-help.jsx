...
const PAGE_DATA = {
  title: "도움 정보 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘도움 정보’에 따라, 고객센터·FAQ·챗봇 등 도움말 진입 위치를 화면마다 일관되게 두는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 도움 정보, help, 고객센터, 이해의 용이성",
}

function ConsistentHelpPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(예측 가능성) : 도움 정보가 제공되는 경우, 각 페이지에 동일한 순서로 접근할 수 있는가?</b><br />
      			도움말 위치가 화면마다 달리면 사용자는 매번 탐색 비용을 치릅니다. 헤더·설정·플로팅 버튼 등 한 가지 패턴을 유지합니다.
      		</p>
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#consistent-help" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Consistent Help</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			일관된 도움 진입점은 인지 부하를 줄이고, 스크린 리더 사용자가 익숙한 제스처로 도움말에 도달하게 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>인지 장애인</strong><p>매 화면에서 도움을 새로 찾는 데 스트레스를 받는 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>‘도움말’이 항상 같은 랜드마크/순서에 있어야 빠르게 도달하는 사용자.</p></li>
      			<li><strong>고령·초보 사용자</strong><p>전화 상담 번호를 급할 때 같은 위치에서 찾으려는 사용자.</p></li>
      			<li><strong>운영·CS팀</strong><p>진입 경로가 일정해야 안내 스크립트가 단순해집니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>위치</strong><p>도움 아이콘이 내비게이션/헤더의 동일한 슬롯에 있는가?</p></li>
      			<li><strong>순서</strong><p>탭 순서·스와이프 순서에서 도움이 항상 같은 상대 위치인가?</p></li>
      			<li><strong>전역 vs 맥락</strong><p>화면별 FAQ와 전역 고객센터가 서로 다른 레이블로 혼동되지 않는가?</p></li>
      			<li><strong>딥링크</strong><p>특정 도움 문서로 바로 열어도 전역 도움 진입이 유지되는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>‘도움말’ 링크의 순서(예: 항상 제목줄 오른쪽 끝)를 템플릿으로 고정합니다.</li>
      			<li>챗봇·전화·FAQ로 이어지는 흐름도 동일한 시작점에서 열리게 합니다.</li>
      			<li>딥링크로 특정 도움 문서를 열 때도 전역 내비게이션은 유지합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>무작위로 5개 화면을 골라 도움말까지 도달하는 스텝 수를 비교합니다.</li>
      			<li>스크린 리더 로터에서 ‘도움’ 관련 컨트롤이 예상 위치에 있는지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">도움 정보 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
...
export default ConsistentHelpPage
