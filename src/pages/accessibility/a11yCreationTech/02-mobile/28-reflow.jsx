...
const PAGE_DATA = {
  title: "리플로우 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘리플로우’에 따라, 확대·좁은 화면에서 가로·세로 동시 스크롤 없이 정보를 읽을 수 있게 레이아웃을 설계하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 리플로우, reflow, 확대, 가로 스크롤, 반응형, 인식의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(명료성) : 확대/작은 화면에서도 가로·세로 동시 스크롤 없이 정보 손실 없이 읽을 수 있는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#reflow" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Reflow</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			리플로우가 되지 않으면 저시력 사용자는 문장을 따라가기 위해 과도한 제스처를 반복하게 됩니다.
      			웹뷰와 네이티브 모두에서 유연한 레이아웃 제약과 줄바꿈 규칙이 필요합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>저시력 사용자</strong><p>큰 글자·확대 뷰에서도 본문을 한 방향 스크롤로 읽고 싶은 사용자.</p></li>
      			<li><strong>작은 기기·멀티윈도우</strong><p>가로폭이 줄었을 때 레이아웃이 깨지지 않아야 하는 사용자.</p></li>
      			<li><strong>한 손 조작</strong><p>가로 스크롤이 잦으면 엄지 도달 영역 밖으로 내용이 밀리는 사용자.</p></li>
      			<li><strong>개발자</strong><p>고정 픽셀·절대 위치 남용을 줄이고 스택·플렉스·제약 기반으로 설계해야 합니다.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>이중 스크롤</strong><p>본문 읽기에 가로·세로 스크롤을 동시에 요구하지 않는가?</p></li>
      			<li><strong>고정 높이</strong><p>라벨·버튼이 확대 시 잘리거나 겹치지 않는가?</p></li>
      			<li><strong>표·지도</strong><p>가로 스크롤이 불가피한 영역은 예외임을 안내하고 대체 요약이 있는가?</p></li>
      			<li><strong>WebView</strong><p>viewport·미디어쿼리가 네이티브와 동일 시나리오에서 검증되었는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>고정 너비(<code>dp</code>·<code>px</code>)만으로 줄을 맞추지 말고, 내용 길이에 따라 줄바꿈되게 합니다.</li>
      			<li>가로 스크롤이 필요한 지도·표 등은 예외 영역임을 시각·음성으로 안내합니다.</li>
      			<li>OS 글자 크기를 최대로 올린 상태에서 주요 시나리오를 회귀 테스트합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>320 CSS 픽셀 수준의 좁은 폭(또는 분할 화면)에서 주요 화면을 캡처해 스크롤 방향을 기록합니다.</li>
      			<li>확대 제스처·접근성 확대 후에도 포커스 순서와 가독성이 유지되는지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">리플로우 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
