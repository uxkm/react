...
const PAGE_DATA = {
  title: "단일 문자 단축키 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘단일 문자 단축키’에 따라, 한 글자 입력만으로 실행되는 기능의 오동작을 막는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 단일 문자 단축키, 키보드 단축키, 운용의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력장치 접근성) : 단일 문자 단축키는 비활성화·재할당·조합키 전환 등 오입력 방지 수단을 제공하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#character-key-shortcuts" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Character Key Shortcuts</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			단일 키 단축은 빠른 조작에 유용하지만, 시선이 다른 곳에 있을 때나 대체 입력 장치를 쓸 때는 오동작의 원인이 됩니다.
      			사용자 설정에서 끄거나 조합키(예: Ctrl+)로만 동작하게 바꿀 수 있게 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>음성 입력·맥락 스위치 사용자</strong><p>문자 단위로 포커스가 이동하며 단축키가 트리거될 수 있는 사용자.</p></li>
      			<li><strong>스크린 리더 사용자</strong><p>탐색 키와 앱 단축키가 충돌하는 사용자.</p></li>
      			<li><strong>외부 키보드 사용자</strong><p>태블릿·접이식 키보드에서 오타로 단축키가 실행되는 사용자.</p></li>
      			<li><strong>전원 사용자</strong><p>단축키를 유지하되 조합키 모드로 전환하고 싶은 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>끄기</strong><p>단일 문자 단축을 완전히 비활성화할 수 있는가?</p></li>
      			<li><strong>재할당</strong><p>다른 키 조합으로 바꿀 수 있는가?</p></li>
      			<li><strong>조합키만</strong><p>기본을 ‘보조 키(Shift 등)+문자’로만 동작하게 두는 옵션이 있는가?</p></li>
      			<li><strong>충돌</strong><p>OS·WebView·IME와 단축키 표가 충돌하지 않는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>하드웨어 키보드·외부 키패드 연결 환경에서 단축키가 충돌하지 않는지 확인합니다.</li>
      			<li>웹뷰와 네이티브가 동시에 단축키를 잡지 않도록 이벤트 전파를 정리합니다.</li>
      			<li>단축키 목록을 설정 화면에 노출하고, 기본값은 ‘비활성’으로 두는 것도 고려합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스크린 리더 켜고 텍스트 필드·목록 탐색 중에 단축키가 의도치 않게 실행되는지 재현합니다.</li>
      			<li>설정에서 끈 뒤 동일 시나리오가 안전한지 회귀 테스트합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">단일 문자 단축키 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
