...
const PAGE_LAYOUT = {
  mainClass: "error-identification",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "오류 정정 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(이해의 용이성)의 '오류 정정'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 입력 도움, 입력 오류 방지, 실시간 피드백, 자동 완성, 힌트 제공, 명확한 오류 메시지",
}

function ErrorIdentificationPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 도움) : 입력 서식 이용 시, 입력 오류를 방지하거나 정정할 수 있는 방법을 제공해야 한다.</b><br />
      			모바일 앱에서 입력 서식을 사용할 때,
      			사용자의 입력 오류를 방지하거나 정정할 수 있는 방법을 제공하는 것은 필수적인 접근성 요건입니다.
      			이를 통해 사용자의 경험을 개선하고 다양한 사용자층이 쉽게 앱을 사용할 수 있도록 합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#error-identification" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Error Identification</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			입력 오류 방지 기능은 사용자가 데이터를 정확하게 입력할 수 있도록 하여 앱 사용의 편의성과 정확성을 높입니다.
      			특히, 시각 장애인, 인지 장애인, 고령 사용자 등에게는 입력 오류 시 빠르고 쉽게 정정할 수 있는 기능이 필수적입니다.
      			입력 도움 기능은 사용자의 스트레스를 줄이고, 앱에 대한 만족도를 높입니다.
      		</p>
      	</section>
      ...
      <CodeBlock title="입력 도움 - iOS 실시간 오류 감지" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      ...
      <CodeBlock title="입력 도움 - Android 실시간 오류 감지" language="javascript" className="uk_gist_code_box">
      {`<EditText
      ...
      <CodeBlock title="입력 도움 - html 입력 필드 및 실시간 검증" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="입력 도움 - Vue 입력 검증 컴포넌트" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      								...
      								<div v-if="errorMessage" aria-live="polite" class="error-message"></div>
      							</div>
      						</template>
      ...
      <CodeBlock title="입력 도움 - React 입력 검증 컴포넌트" language="html" className="uk_gist_code_box">
      {`import React, { useState } from 'react';
      						...
      						function App() {
      							...
      							return (
      								<div>
      									...
      									{errorMessage && <div aria-live="polite" className="error-message" style={{ color: "red" }}>{errorMessage}</div>}
      								</div>
      							);
      						}`}
      </CodeBlock>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>접근성 지침 준수</strong>
      				<p>
      					입력 오류 피드백이 WCAG의 입력 오류 방지 기준을 충족하는지 점검합니다.
      				</p>
      			</li>
      			<li>
      				<strong>에러 메시지 가시성</strong>
      				<p>
      					시각적으로 명확하게 표시되는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>스크린 리더 대응</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/ALkmLGAHeFg?si=Rx9pcZ9IkNlTstop" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (12. 입력 요소의 용도와 목적 정보 제공)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">오류 정정 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
...
export default ErrorIdentificationPage
