...
const PAGE_DATA = {
  title: "초점 이동과 표시 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '초점 이동과 표시'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 초점, 논리적 순서, 키보드 내비게이션, 스크린 리더, TalkBack, VoiceOver",
}

function FocusVisiblePage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">
      				관련 지침(입력장치 접근성) : 의미나 기능을 갖는 모든 사용자 인터페이스 컴포넌트에는 초점(focus)이 적용되고,
      				초점은 논리적인 순서로 이동되어야 한다.
      			</b><br />
      			초점 관리와 논리적 순서 유지는 모든 사용자가 앱 내에서 효율적으로 탐색하고 상호작용할 수 있도록 돕는 중요한 요소입니다.
      			올바르게 설계된 초점 순서는 사용자 경험을 향상시키고, 특히 키보드 및 스크린 리더 사용자에게 필수적인 편의를 제공합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#focus-order" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Focus Order</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			초점 이동이 논리적 순서로 설정되지 않으면 사용자 경험이 혼란스러워지고,
      			특히 키보드 사용자와 스크린 리더 사용자는 주요 기능을 놓칠 위험이 있습니다.
      			초점이 논리적으로 이동함으로써 사용자가 흐름을 예측할 수 있고, 중요한 요소에 쉽게 접근할 수 있게 됩니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				<strong>키보드 접근성 보장</strong>
      				<p>
      					모든 중요한 인터페이스 요소가 키보드로 접근 가능해야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>초점 고정 방지</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>논리적 초점 이동률</strong>
      				<p>
      					초점이 순차적으로 논리적인 순서로 이동하는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>초점 표시 명확성</strong>
      				<p>
      					초점이 위치한 요소가 시각적으로 명확하게 표시되는지 점검합니다.
      				</p>
      			</li>
      			<li>
      				<strong>키보드 테스트 통과율</strong>
      				<p>
      ...
      <CodeBlock title="초점 - iOS 초점 관리" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      ...
      <CodeBlock title="초점 - Android 초점 관리" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="초점 - html 초점 관리" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="초점 - Vue 초점 관리" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      ...
      <CodeBlock title="초점 - React 초점 관리" language="javascript" className="uk_gist_code_box">
      {`import React, { useEffect, useRef } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_ml dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>초점 이동의 논리성</strong>
      				<p>
      					모든 요소에 초점이 논리적인 순서로 이동하는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>시각적 초점 표시</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/sxaElogrIgs?si=vnuvTKdloFq7TQ4z" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">초점 이동과 표시 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default FocusVisiblePage
