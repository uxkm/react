...
const PAGE_DATA = {
  title: "응답시간 조절 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '응답시간 조절'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 응답 시간 조절, 시간 제한, 사용자 제어, 타이머 설정, 시간 연장, 인지 장애 사용자, 운동 장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(충분한 시간 제공) : 시간 제한이 있는 콘텐츠는 응답 시간을 조절할 수 있어야 한다.</b><br />
      			응답 시간 조절 기능을 제공함으로써 사용자는 콘텐츠에 필요한 만큼의 시간을 확보할 수 있고,
      			특히 접근성이 필요한 사용자에게 필수적인 유연성을 제공합니다.
      			이러한 방법으로 모든 사용자에게 시간을 조절할 수 있는 옵션을 제공하여 접근성을 높일 수 있습니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#timing-adjustable" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Timing Adjustable</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				<strong>타이머 경고 제공</strong>
      				<p>
      					시간 제한이 임박했을 때 사용자에게 알림을 제공합니다.
      				</p>
      			</li>
      			<li>
      				<strong>시간 연장 방법의 다양성</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>시간 연장 가능 여부</strong>
      				<p>
      					사용자 요청에 따라 시간 제한을 연장할 수 있는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>경고 제공 여부</strong>
      				<p>
      					시간 제한이 임박했을 때 사용자에게 경고가 제공되는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>사용자 만족도</strong>
      				<p>
      ...
      <CodeBlock title="응답 시간 조절 - iOS 시간 연장 버튼 제공" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      ...
      <CodeBlock title="응답 시간 조절 - Android 연장 다이얼로그 구현" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="응답 시간 조절 - html 시간 연장 대화상자 제공" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="응답 시간 조절 - Vue 시간 연장 구현" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      								<p>남은 시간: 초</p>
      ...
      <CodeBlock title="응답 시간 조절 - React 시간 연장 구현" language="javascript" className="uk_gist_code_box">
      {`import React, { useEffect, useState } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/erHH3hX9OgI?si=SsARKrXEhpO8ZoiJ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (9. 응답시간조절)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">응답시간 조절 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
