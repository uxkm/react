...
const PAGE_DATA = {
  title: "단일 포인터 입력 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '단일 포인터 입력'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 누르기 동작, 터치 제어, 손쉬운 터치 영역, 반응성, 운동 장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 방식) : 터치(touch) 기반 모바일 기기의 모든 컨트롤은 누르기 동작으로 제어할 수 있어야 한다.</b><br />
      			터치 기반 모바일 기기에서 접근성을 보장하기 위해서는 누르기 동작 지원이 필수적입니다.
      			모든 사용자가 손가락으로 쉽게 조작할 수 있는 충분한 터치 영역을 제공하고,
      			시각적 피드백을 통해 명확하게 반응하는 인터페이스를 구현함으로써 사용자 경험을 크게 향상시킬 수 있습니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#pointer-gestures" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Pointer Gestures</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>모든 모바일 사용자</strong>
      				<p>
      					터치 기반 모바일 기기를 사용하는 모든 사용자.
      				</p>
      			</li>
      			<li>
      				<strong>운동 장애 사용자</strong>
      				<p>
      					작은 터치 영역을 다루기 어려운 사용자에게 필수적입니다.
      				</p>
      			</li>
      			<li>
      				<strong>시각 장애 사용자</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				...
      				<p>
      					모바일 브라우저에서 터치 기반 제어 요소가 잘 작동하는지,
      					특히 Tab 키를 통해 손가락 터치와 동일한 인터랙션을 제공하는지 점검합니다.
      				</p>
      			</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>터치 반응성</strong>
      				<p>
      					터치에 대한 응답 시간이 빠르고, 명확하게 반응하는지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>터치 영역 크기 충족 여부</strong>
      				<p>
      					모든 터치 가능 영역이 최소 크기 기준을 충족하는지 점검합니다.
      				</p>
      			</li>
      			<li>
      				<strong>피드백 제공 여부</strong>
      				<p>
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_l indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>UIButton을 사용한 터치 반응 설정</span>
      						
      <CodeBlock title="누르기 동작 지원 - 터치 반응 설정" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      					...
      					<li>
      						<span>터치 영역 확장: UIButton의 터치 영역을 넓히기 위해 터치 영역을 추가로 설정합니다.</span>
      						
      <CodeBlock title="누르기 동작 지원 - 터치 영역 확장" language="javascript" className="uk_gist_code_box">
      {`extension UIButton {
      			...
      			<div className="mt_l indent">
      				...
      				<ul className="mt_ms dot_lst gap-column-important-m">
      					<li>
      						<span>Button을 사용한 터치 이벤트 설정</span>
      						
      <CodeBlock title="누르기 동작 지원 - 터치 이벤트 설정" language="javascript" className="uk_gist_code_box">
      {`import android.os.Bundle
      					...
      					<li>
      						<span>터치 영역 확대: 터치 영역이 충분히 넓어지도록 설정하여 사용자의 실수를 줄입니다.</span>
      						
      <CodeBlock title="누르기 동작 지원 - 터치 영역 확대" language="javascript" className="uk_gist_code_box">
      {`<Button
      ...
      <CodeBlock title="누르기 동작 지원 - 터치 가능 영역 설정" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="누르기 동작 지원 - 터치 제어" language="javascript" className="uk_gist_code_box">
      {`import React from 'react';
      						...
      						function App() {
      							...
      							return (
      								<button onClick={handleClick} style=>확인</button>
      							);
      						}
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/PF2oBsrgRKY?si=TDYOYxCCty814e_E" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			[출처 : NULI 모바일 앱 접근성 (8. 누르기 동작 지원)]
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">단일 포인터 입력 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
