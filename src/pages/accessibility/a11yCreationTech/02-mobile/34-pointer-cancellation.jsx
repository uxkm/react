...
const PAGE_DATA = {
  title: "포인터 입력 취소 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘포인터 입력 취소’에 따라, 오탭·드래그 실수를 되돌리거나 실행 전에 취소할 수 있게 하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 포인터 취소, 되돌리기, Undo, touch, 운용의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력 방식) : 단일 포인터 입력으로 실행되는 기능의 오입력을 취소·중단·되돌릴 수 있는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#pointer-cancellation" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Pointer Cancellation</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			되돌리기(Undo), 삭제 확인, 슬라이더의 값 복원 등은 치명적 오류를 줄이는 기본 패턴입니다.
      			제스처가 즉시 반응하는 대신 짧은 유예나 ‘놓을 때 확정’ 패턴을 고려합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>파킨슨·떨림이 있는 사용자</strong><p>탭이 이중으로 들어가기 쉬운 사용자.</p></li>
      			<li><strong>터치 도구 사용자</strong><p>손가락 대신 스타일러스·입술 스틱으로 정밀도가 달라지는 사용자.</p></li>
      			<li><strong>시각 장애인</strong><p>타깃 중심을 맞추기 어려워 인접 버튼을 누르기 쉬운 사용자.</p></li>
      			<li><strong>전체 사용자</strong><p>이동 중 한 손으로 잘못 누르는 일반적인 실수를 줄이려는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>업 실행 전 취소</strong><p>손가락을 뗄 때까지 실행이 확정되지 않는가?</p></li>
      			<li><strong>실행 후 취소</strong><p>삭제·전송 등에 실행 취소 스낵바나 되돌리기가 있는가?</p></li>
      			<li><strong>중요 동작</strong><p>결제·계약에는 확인 단계가 있는가?</p></li>
      			<li><strong>드래그 충돌</strong><p>맵·캔버스에서 드래그와 탭이 서로 오작동하지 않는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스와이프로 삭제되는 리스트는 실행 취소 스낵바 등을 제공합니다.</li>
      			<li>맵·캔버스에서 드래그와 탭이 겹칠 때 히트 영역과 제스처 임계값을 조정합니다.</li>
      			<li>결제·전송 등 되돌릴 수 없는 동작은 반드시 확인 단계를 둡니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>의도적으로 살짝 빗겨 탭·빠르게 두 번 탭하는 등 실수 패턴을 재현합니다.</li>
      			<li>스위치 제어·느린 탭 시뮬레이션에서도 동작이 안전한지 확인합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">포인터 입력 취소 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
