...
const PAGE_DATA = {
  title: "조작 가능한 크기 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(운용의 용이성)의 '조작 가능한 크기'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단말기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 컨트롤 크기와 간격, 터치 영역, 터치 간격, 터치 정확성, 운동 장애 사용자, 고령 사용자",
}

function TargetSizeMinimumPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(입력장치 접근성) : 컨트롤은 충분한 크기와 간격으로 제공되어야 한다.</b><br />
      			모든 사용자에게 적절한 크기와 간격을 갖춘 터치 가능한 인터페이스 요소를 제공하면,
      			사용자 경험을 향상시킬 뿐 아니라 접근성을 보장할 수 있습니다.
      			충분한 터치 영역과 간격을 확보함으로써 모든 사용자가 쉽게 조작할 수 있는 환경을 제공할 수 있습니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#target-size-minimum" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Target Size (Minimum)</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>최소 크기 기준 준수</strong>
      				<p>
      					컨트롤의 크기가 최소 44x44 픽셀 이상인지 확인합니다.
      				</p>
      			</li>
      			<li>
      				<strong>적절한 간격 제공</strong>
      				<p>
      ...
      <CodeBlock title="컨트롤의 크기와 간격 - iOS 버튼 크기와 간격" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      ...
      <CodeBlock title="컨트롤의 크기와 간격 - Android 버튼 크기와 간격" language="javascript" className="uk_gist_code_box">
      {`<LinearLayout
      ...
      <CodeBlock title="컨트롤의 크기와 간격 - HTML 버튼 크기와 간격" language="javascript" className="uk_gist_code_box">
      ...
      <CodeBlock title="컨트롤의 크기와 간격 - Vue 버튼 크기와 간격" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      								<button class="large-button">버튼 1</button>
      								<button class="large-button">버튼 2</button>
      ...
      <CodeBlock title="컨트롤의 크기와 간격 - React 버튼 크기와 간격" language="javascript" className="uk_gist_code_box">
      {`import React from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/HndGi_6j0_I?si=jGl3Hv244oa6X_Ul" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (11. 컨트롤의 크기와 간격)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">조작 가능한 크기 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
...
export default TargetSizeMinimumPage
