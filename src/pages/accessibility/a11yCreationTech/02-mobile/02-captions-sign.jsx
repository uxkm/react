...
const PAGE_DATA = {
  title: "자막 또는 수어 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 접근성 콘텐츠 제작 기법 중 하나인 '자막, 수화 등의 제공'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 자막, 수화, 접근성 테스트 도구 활용 점검방법, 스크린 리더, VoiceOver, TalkBack, 네이티브, 하이브리드, 청각 장애인, 고령자, 언어 비숙련자",
}

function CaptionsSignPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(멀티미디어 대체수단) : 영상이나 음성 콘텐츠에는 동등한 내용의 자막, 원고 또는 수화가 제공되어야 하는가?</b><br />
      			자막과 수화는 청각 장애인을 포함한 다양한 사용자들이 동영상, 강의,
      			프레젠테이션과 같은 멀티미디어 콘텐츠의 모든 정보를 얻을 수 있도록 하는 필수적인 접근성 요소입니다.<br />
      			자막은 음성 정보를 텍스트로 전달하고, 원고와 수화는 보조기술 및 다양한 이용 환경에서 콘텐츠 이해를 지원합니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#captions-prerecorded" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Captions (Prerecorded)</a><br />
      			<a href="https://www.w3.org/WAI/media/av/" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">W3C - 자막 및 수화 관련 지침</a><br />
      			<a href="https://support.microsoft.com/ko-kr/office/%EB%B9%84%EB%94%94%EC%98%A4%EC%97%90-%EB%8C%80%ED%95%9C-%EC%84%A0%ED%83%9D-%EC%9E%90%EB%A7%89-%EB%A7%8C%EB%93%A4%EA%B8%B0-b1cfb30f-5b00-4435-beeb-2a25e115024b" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">Microsoft Support - 비디오에 대한 선택 자막 만들기</a><br />
      			<a href="https://support.wecandeo.com/docs/videopack-guide-caption-convert#webvtt%EB%9E%80" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WebVTT란?</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>소리를 듣지 못하는 사용자</strong>
      				<p>
      					멀티미디어 콘텐츠의 음성 정보(내레이션 등)를 인식할 수 없기 때문에
      					이와 동등한 대체 콘텐츠(자막, 대본 또는 수화 등)를 함께 제공하지 않으면
      					멀티미디어 콘텐츠에서 정보를 인식할 수 없습니다.<br />
      					멀티미디어 콘텐츠의 음성 정보의 문맥과 동등한 수준의 자막, 대본 및 수화를 함께 제공해야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>영상을 보지 못하는 사용자</strong>
      				<p>
      					멀티미디어 콘텐츠의 영상 정보(텍스트 등)를 인식할 수 없기 때문에
      					이와 동등한 대체 (콘텐츠 원고 또는 내레이션 등)를 함께 제공하지 않으면 멀티미디어 콘텐츠에서 정보를 인식할 수 없습니다.
      					그러므로 멀티미디어 콘텐츠의 영상 정보의 문맥과 동등한 수준의 대체 콘텐츠(콘텐츠 원고 또는 내레이션 등)를
      					함께 제공해야 합니다.
      				</p>
      			</li>
      			<li>
      				<strong>소리를 들을 수 없는 환경</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			...
      			<li>
      				<strong>난청 사용자</strong>
      				<p>
      					음성 콘텐츠를 충분히 이해하기 어려운 사용자.
      				</p>
      			</li>
      			<li>
      				<strong>언어 비숙련자</strong>
      				<p>
      			...
      			<li>
      				<strong>다양한 언어를 사용하는 사용자</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">자막 관련 항목</h3>
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				<li>
      					<b>대사와 일치하는가</b>: 자막이 음성 대사와 정확하게 일치하는지 확인합니다.
      				</li>
      				<li>
      					<b>동작, 소리 설명</b>: 대사 외에도 중요한 배경 소리(문 두드리는 소리, 음악 등)나 동작에 대한 설명을 포함하는지 확인합니다.
      				</li>
      				<li>
      					<b>적절한 동기화</b>: 자막이 화면에 표시되는 시간이 음성 콘텐츠와 일치하는지 확인합니다.
      				</li>
      				<li>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">수화 관련 항목</h3>
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				<li>
      					<b>화면에서 잘 보이는 위치 제공</b>: 수화 영상이 화면에서 가려지지 않고 명확하게 표시되는지 확인합니다.
      				</li>
      				<li>
      					<b>콘텐츠 전체 제공 여부</b>: 수화가 콘텐츠 전체를 충분히 설명하는지 확인합니다.
      				</li>
      				<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst info_lst gap-column-important-ms reference">
      				...
      				<li>
      					<strong>자막 및 SDH 설정</strong>
      					<p>
      						설정 &gt; 접근성 &gt; 자막 및 SDH 설정을 통해 자막이 제대로 활성화되는지 테스트합니다.
      					</p>
      				</li>
      				<li>
      					<strong>비디오 재생</strong>
      					<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li>
      				<strong>자막 정확성</strong>
      				<p>
      					자막이 음성과 일치하는지 확인하는 비율.
      				</p>
      			</li>
      			<li>
      				<strong>수화 정확성</strong>
      				<p>
      					수화가 음성 콘텐츠와 일치하는지 확인하는 비율.
      				</p>
      			</li>
      			<li>
      				<strong>동기화 정확성</strong>
      				<p>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">네이티브 (iOS) - 자막 적용</h3>
      			
      <CodeBlock title="자막, 수화 등의 제공 - 네이티브 (iOS)" language="javascript" className="uk_gist_code_box mt_m">
      {`let videoPlayer = AVPlayer(url: videoURL)
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">네이티브 (Android) - 자막 파일과 함께 비디오 재생</h3>
      			
      <CodeBlock title="자막, 수화 등의 제공 - 네이티브 (Android)" language="javascript" className="uk_gist_code_box mt_m">
      {`videoView.addSubtitleSource(new FileInputStream(subtitleFile), MediaFormat.createSubtitleFormat("text/vtt", Locale.getDefault().getLanguage()));`}
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">하이브리드(html)</h3>
      			
      <CodeBlock title="자막, 수화 등의 제공 - 하이브리드(html)" language="javascript" className="uk_gist_code_box mt_m">
      {`<video controls>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">하이브리드(Vue)</h3>
      			
      <CodeBlock title="자막, 수화 등의 제공 - 하이브리드(Vue)" language="javascript" className="uk_gist_code_box mt_m">
      {`<template>
      					<video controls>
      						<source src="video.mp4" type="video/mp4" />
      						<track kind="captions" src="subtitles_en.vtt" srclang="en" label="English" />
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">하이브리드(React)</h3>
      			
      <CodeBlock title="자막, 수화 등의 제공 - 하이브리드(React)" language="javascript" className="uk_gist_code_box mt_m">
      {`function VideoComponent() {
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">자막 점검 기준</h3>
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				<li>
      					자막이 정확하게 음성과 일치하는가?
      				</li>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn">수화 점검 기준</h3>
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				<li>
      		...
      		<article className="mt_xl indent">
      			...
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				...
      				<li>
      					유의미한 음성정보 없이 화면에 텍스트로만 정보를 제공하거나,
      					영상스케치 등의 동영상의 경우 화면에 제공되는 정보를 화면밖에 시각장애인이 확인할 수 있도록
      					대체정보를 제공하여야 합니다.(스케치의 경우 대략적인 요약정보 제공 인정)
      				</li>
      				<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			멀티미디어 콘텐츠 등에 음성정보를 대체할 수 있는 수단(자막, 원고, 수화 등)을 제공하고 있는 지,
      			유의미한 음성정보 없이 화면으로만 정보를 제공하는 경우 화면정보를 인지할 수 있도록 대체정보를 제공하는 지를 점검합니다.
      		</p>

      		<article className="mt_xl indent">
      			<h3 className="ml_mn">점검사항</h3>
      			<ul className="mt_ml dot_lst gap-column-important-sm">
      				<li>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">사례 1) 음성정보에 대체수단(자막)을 제공한 경우</h3>
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_01.png`} alt="" />
      				<figcaption>
      					[출처 : AOA11Y]
      				</figcaption>
      			</figure>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">사례 2) 음성정보에 대체수단(수화)를 제공한 경우</h3>
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_02.png`} alt="" />
      				<figcaption>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">사례 3) 문자정보에 대체수단(원고)를 제공한 경우</h3>
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_03.png`} alt="" className="max-w350" />
      				<figcaption>
      					[출처 : 라이나생명]
      				</figcaption>
      			</figure>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">사례 4) 비디오 관리자의 자막 설정에서 적절한 내용으로 자막을 수정한 경우</h3>
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_04.png`} alt="" />
      				<figcaption>
      					[출처 : 무인정보단말기 UI 플랫폼]
      				</figcaption>
      			</figure>
      			<p className="mt_ms">
      				유튜브 크리에이터 스튜디오의 <mark>'동영상 관리자 메뉴'</mark>에서 자막을 수정하거나 삽입하고 싶은 동영상을 선택하고
      				<mark>'자막'</mark> 탭을 살펴보면 새 자막을 추가하거나 이미 삽입된 자막을 수정할 수 있습니다.
      			</p>
      		</article>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_05.png`} alt="" />
      				<figcaption>
      					[출처 : 무인정보단말기 UI 플랫폼]
      				</figcaption>
      			</figure>
      		...
      		<article className="mt_xl indent">
      			<h3 className="ml_mn t_blue">사례 2) 음성정보 전체가 아닌 일부정보나 요약정보만을 제공하는 경우</h3>
      			<figure className="mt_l img_figure">
      				<img src={`${IMG.A11Y_TECH_M_P_52}/5.2.a11y_tmp_06.png`} alt="" />
      				<figcaption>
      					[출처 : 무인정보단말기 UI 플랫폼]
      				</figcaption>
      			</figure>
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/vtKmpY28IRs?si=Am4mOxcWA-kW0p1j" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">자막 또는 수어 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default CaptionsSignPage
