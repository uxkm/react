...
const PAGE_DATA = {
  title: "사용자 요구에 따른 실행 | 모바일 접근성 콘텐츠 제작 기법(\"이해의 용이성(Understandable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 모바일 앱 접근성 체크리스트(이해의 용이성)의 '사용자 요구에 따른 실행'에 대해 소개합니다.",
  keyword: "Accessibility, a11y, wcag, kwcag, macag, kiosk, 접근성, 웹 콘텐츠 접근성, 한국형 웹 콘텐츠 접근성, 모바일 앱 접근성, 무인정보단밀기 접근성, 모바일 앱 접근성, 모바일 앱 접근성 콘텐츠 제작 기법, WCAG2.2, 예측가능성, 자동 전환 방지, 사용자 제어, 이벤트 이해 가능성, 피드백, 인지 장애 사용자",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(예측 가능성) : 사용자가 의도하지 않은 기능은 자동적으로 실행되지 않는가?</b><br />
      			모바일 앱과 웹 애플리케이션에서 예측가능성은 사용자가 예상치 못한 화면 전환이나 이벤트에 당황하지 않도록 하여
      			사용 경험을 높이는 중요한 접근성 원칙입니다.
      			예측 가능한 인터페이스는 특히 인지 장애가 있는 사용자나 기술에 익숙하지 않은 사용자에게 필수적입니다.
      		</p>
      		<p className="mt_ms reference">
      			<a href="/accessibility/a11y/04-a11yCag/03-macag" className="fas weight-500">모바일 앱 접근성 체크리스트(MACAG) — 이해의 용이성</a><br />
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#predictable" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 Quick Reference - Predictability</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			예측 불가능한 화면 전환이나 이벤트는 사용자가 혼란을 느끼고, 심각한 경우 중요한 정보나 기능을 놓치게 만들 수 있습니다.
      			특히, 사용자의 의도와 상관없이 화면이 전환되거나 특정 이벤트가 발생하면 인지 장애가 있는 사용자에게는 불편을 초래하며,
      			스크린 리더 사용자에게는 정보 접근을 어렵게 합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_l indent">
      				...
      				<p className="mt_ms">
      					<b>UIAlertController를 통한 사용자 확인 요청</b> : 사용자에게 화면 전환을 알리고 확인을 요청합니다.
      				</p>
      				
      <CodeBlock title="예측가능성 - iOS 화면 전환 알림" language="javascript" className="uk_gist_code_box">
      {`import UIKit
      			...
      			<div className="mt_l indent">
      				<h4 className="ml_mn">Android (Kotlin)</h4>
      				<p className="mt_ms">
      					<b>AlertDialog를 이용한 사용자 확인</b> : 화면 전환 전 사용자 동의를 구하여 예기치 않은 전환을 방지합니다.
      				</p>
      				
      <CodeBlock title="예측가능성 - Android 화면 전환 알림" language="javascript" className="uk_gist_code_box">
      {`import android.content.DialogInterface
      		...
      		<article className="mt_xl indent">
      			...
      			<div className="mt_ml indent">
      				<h4 className="ml_mn">하이브리드(html/JavaScript)</h4>
      				<p className="mt_ms">
      					<b>사용자 제어를 포함한 경고 제공</b> : 화면 전환을 위한 버튼 클릭 시 사용자에게 경고 메시지를 표시합니다.
      				</p>
      				
      <CodeBlock title="예측가능성 - html 화면 전환 알림" language="html" className="uk_gist_code_box">
      {`<button onclick="confirmTransition()">페이지 전환</button>
      			...
      			<div className="mt_l indent">
      				...
      				<p className="mt_ms">
      					<b>자동 이벤트 중지 및 사용자 알림 제공</b> : 페이지가 자동으로 전환되지 않도록 하고, 사용자에게 알림을 제공합니다.
      				</p>
      				
      <CodeBlock title="예측가능성 - Vue 화면 전환 알림" language="javascript" className="uk_gist_code_box">
      {`<template>
      							<div>
      ...
      <CodeBlock title="예측가능성 - React 화면 전환 알림" language="javascript" className="uk_gist_code_box">
      {`import React, { useState } from 'react';
      	...
      	<section className="indent mt_xxl">
      		...
      		<div className="mt_xl youtube_box" style={{ '--padding-top': "56.25%" }}>
      			<iframe width="560" height="315" src="https://www.youtube.com/embed/B_tezDF6CXo?si=CotSIdAZlPC0x4jZ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      		</div>
      		<p className="mt_ms">
      			출처 : NULI 모바일 앱 접근성 (16. 예측 가능성)
      		</p>
      	</section>
      ...
      <footer className="reference_box">
      	<strong className="tit">사용자 요구에 따른 실행 | 모바일 접근성 콘텐츠 제작 기법(&quot;이해의 용이성(Understandable)&quot;) 참조</strong>
