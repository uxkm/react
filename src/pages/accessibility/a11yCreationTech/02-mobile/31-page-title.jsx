...
const PAGE_DATA = {
  title: "제목 | 모바일 접근성 콘텐츠 제작 기법(\"운용의 용이성(Operable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘제목’에 따라, 화면·주요 블록에 맥락을 드러내는 제목을 제공하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 제목, page title, navigationBar, heading, 운용의 용이성",
}
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(쉬운 내비게이션) : 페이지·화면·주요 콘텐츠 블록에 내용을 대표하는 적절한 제목을 제공하는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#page-titled" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Page Titled</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			제목이 없거나 중복되면 여러 화면을 오갈 때 길을 잃기 쉽습니다.
      			각 화면의 고유 목적이 드러나도록 짧고 구체적인 제목을 제공합니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>스크린 리더 사용자</strong><p>헤딩/제목만으로 화면 목록을 탐색하는 사용자.</p></li>
      			<li><strong>인지 장애인</strong><p>‘설정’처럼 포괄적인 제목보다 ‘알림 설정’처럼 구체적일 때 이해가 빠른 사용자.</p></li>
      			<li><strong>멀티태스킹 사용자</strong><p>앱 전환 썸네일·최근 목록에서 화면을 구분하려는 사용자.</p></li>
      			<li><strong>고객 지원·QA</strong><p>스크린 이름이 버그 리포트와 일치해야 재현이 쉬운 담당자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>고유성</strong><p>주요 화면 제목이 앱 내에서 서로 구별되는가?</p></li>
      			<li><strong>모달·시트</strong><p>상위 화면 제목만 반복하지 않고 하위 작업명을 드러내는가?</p></li>
      			<li><strong>본문 헤딩</strong><p>긴 스크롤 화면에 섹션 헤딩이 있어 로터 탐색이 가능한가?</p></li>
      			<li><strong>접근성 트리</strong><p>내비게이션 바 제목과 VoiceOver/TalkBack이 읽는 이름이 일치하는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>iOS: <code>UINavigationItem.title</code>, 큰 제목 표시 여부, 접근성 헤더 특성 등을 점검합니다.</li>
      			<li>Android: <code>Toolbar</code>·<code>CollapsingToolbarLayout</code>의 제목과 <code>contentDescription</code> 일관성을 맞춥니다.</li>
      			<li>모달·시트가 열릴 때는 상위 화면 제목만 반복하지 않고 하위 작업명을 구분해 줍니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>스크린 리더 헤딩/제목 로터로 앱 주요 플로우를 순회해 이름이 충분히 구체적인지 확인합니다.</li>
      			<li>딥링크로 바로 진입했을 때도 제목이 맥락을 설명하는지 검증합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">제목 | 모바일 접근성 콘텐츠 제작 기법(&quot;운용의 용이성(Operable)&quot;) 참조</strong>
