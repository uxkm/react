...
const PAGE_LAYOUT = {
  mainClass: "multisensory-support",
  type: "accessibility",
  titleSticky: true,
  info: false,
  note: true,
...
const PAGE_DATA = {
  title: "다양한 감각 지원 | 모바일 접근성 콘텐츠 제작 기법(\"인식의 용이성(Perceivable)\")",
  description: "모바일 접근성 콘텐츠 제작 기법이란 장애 유무에 관계없이 모든 사용자가 모바일 콘텐츠를 쉽게 이해하고 이용할 수 있도록 하는 설계하는 방법입니다. 이 페이지에서는 MACAG ‘다양한 감각 지원’에 따라, 색·위치·소리 등 단일 감각에만 의존하지 않도록 지시와 피드백을 설계하는 방법을 정리합니다.",
  keyword: "Accessibility, a11y, macag, WCAG, 다양한 감각, 색에 무관, 위치 단서, 청각, 햅틱, 인식의 용이성",
}

function MultisensorySupportPage() {
  ...
  return (
    <>
      	...
      	<blockquote className="uk_note mt_xxl" role="note">
      		...
      		<p>
      			<b className="t_black">관련 지침(적응성) : 지시·알림이 색·위치·소리 등 한 가지 감각에만 의존하지 않도록 제공했는가?</b><br />
      		...
      		<p className="mt_ms reference">
      			...
      			<a href="https://www.w3.org/WAI/WCAG22/quickref/#sensory-characteristics" title="새창 열림" target="_blank" rel="noreferrer" className="fas weight-500">WCAG 2.2 — Sensory Characteristics</a>
      		</p>
      	</blockquote>
      	...
      	<section className="indent mt_xxl">
      		...
      		<p className="mt_l">
      			조용한 환경·청각 장애·색약·시야 좁힘 등 사용자 상황은 다양합니다.
      			동일한 의미가 시각·청각·촉각 중 두 가지 이상으로 확인 가능할 때 신뢰도가 높아집니다.
      		</p>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>색각 이상·저시력</strong><p>색만으로 상태를 구분하기 어려운 사용자.</p></li>
      			<li><strong>청각 장애</strong><p>소리 알림만으로는 변화를 인지하지 못하는 사용자.</p></li>
      			<li><strong>시각 장애</strong><p>‘오른쪽’ 등 위치 설명만으로는 대상을 찾기 어려운 사용자.</p></li>
      			<li><strong>전체 사용자</strong><p>주행 중·회의 중 등 소리·진동을 끈 상태에서도 UI를 써야 하는 사용자.</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst info_lst gap-column-important-m">
      			<li><strong>색+무엇</strong><p>오류·성공·경고에 색과 함께 아이콘·텍스트 라벨이 있는가?</p></li>
      			<li><strong>위치 설명</strong><p>‘위/아래’ 대신 컨트롤 이름·랜드마크 기준 설명을 병행하는가?</p></li>
      			<li><strong>소리</strong><p>소리만 있는 알림에 시각 토스트·배지·배너가 동반되는가?</p></li>
      			<li><strong>햅틱</strong><p>진동 패턴이 의미를 전달한다면 설정에서 끌 수 있는가?</p></li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>토스트와 스낵바에 <code>accessibilityLiveRegion</code>(Android) / 적절한 알림(iOS)을 연결합니다.</li>
      			<li>폼 오류는 필드 인접 메시지와 요약 영역을 함께 제공합니다.</li>
      			<li>지도·게임 등 위치 의존 UI는 음성 랜드마크와 탐색 모드를 제공합니다.</li>
      		</ul>
      	</section>
      	...
      	<section className="indent mt_xxl">
      		...
      		<ul className="mt_l dot_lst gap-column-important-sm">
      			<li>색 필터·고대비 모드에서 상태 구분이 유지되는지 확인합니다.</li>
      			<li>무음·진동 끔 상태에서 알림 시나리오를 재현합니다.</li>
      		</ul>
      	</section>
      <section className="indent mt_xxl">
      ...
      <footer className="reference_box">
      	<strong className="tit">다양한 감각 지원 | 모바일 접근성 콘텐츠 제작 기법(&quot;인식의 용이성(Perceivable)&quot;) 참조</strong>
...
export default MultisensorySupportPage
