-- Supabase SQL Editor용: 댓글 ip_hash·rate limit·최소 제출 시간 보강
-- ※ 오버로드 충돌이 있으면 fix_comment_rpc_consolidate.sql 한 번에 실행하는 것을 권장합니다.
...
begin
  for r in
    ...
    where n.nspname = 'public'
      ...
      and pg_get_function_identity_arguments(p.oid) not like '%p_ip_hash%'
  loop
